...
export default class PicklistCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:sys:event:picklist-created:1-0-0', PicklistCreatedV1,
      [],
      [
...
MessageResolver.register('bachelornation:sys:event:picklist-created', PicklistCreatedV1);
