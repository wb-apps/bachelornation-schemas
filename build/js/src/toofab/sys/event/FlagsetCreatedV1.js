...
export default class FlagsetCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:sys:event:flagset-created:1-0-0', FlagsetCreatedV1,
      [],
      [
...
MessageResolver.register('bachelornation:sys:event:flagset-created', FlagsetCreatedV1);
