...
export default class FlagsetDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:sys:event:flagset-deleted:1-0-0', FlagsetDeletedV1,
      [],
      [
...
MessageResolver.register('bachelornation:sys:event:flagset-deleted', FlagsetDeletedV1);
