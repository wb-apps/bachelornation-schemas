...
export default class SearchRedirectsResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:sys:request:search-redirects-response:1-0-0', SearchRedirectsResponseV1,
      [],
      [
...
MessageResolver.register('bachelornation:sys:request:search-redirects-response', SearchRedirectsResponseV1);
