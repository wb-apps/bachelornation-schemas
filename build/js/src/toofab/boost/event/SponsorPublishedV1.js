...
export default class SponsorPublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:boost:event:sponsor-published:1-0-0', SponsorPublishedV1,
      [],
      [
...
MessageResolver.register('bachelornation:boost:event:sponsor-published', SponsorPublishedV1);
