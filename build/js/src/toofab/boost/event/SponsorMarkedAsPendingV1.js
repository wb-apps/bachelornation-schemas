...
export default class SponsorMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:boost:event:sponsor-marked-as-pending:1-0-0', SponsorMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('bachelornation:boost:event:sponsor-marked-as-pending', SponsorMarkedAsPendingV1);
