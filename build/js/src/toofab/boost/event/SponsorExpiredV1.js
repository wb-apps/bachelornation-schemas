...
export default class SponsorExpiredV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:boost:event:sponsor-expired:1-0-0', SponsorExpiredV1,
      [],
      [
...
MessageResolver.register('bachelornation:boost:event:sponsor-expired', SponsorExpiredV1);
