...
export default class ExpireSponsorV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:boost:command:expire-sponsor:1-0-0', ExpireSponsorV1,
      [],
      [
...
MessageResolver.register('bachelornation:boost:command:expire-sponsor', ExpireSponsorV1);
