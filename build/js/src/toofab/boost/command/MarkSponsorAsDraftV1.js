...
export default class MarkSponsorAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:boost:command:mark-sponsor-as-draft:1-0-0', MarkSponsorAsDraftV1,
      [],
      [
...
MessageResolver.register('bachelornation:boost:command:mark-sponsor-as-draft', MarkSponsorAsDraftV1);
