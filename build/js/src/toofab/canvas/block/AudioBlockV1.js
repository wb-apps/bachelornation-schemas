...
export default class AudioBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:audio-block:1-0-0', AudioBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:audio-block', AudioBlockV1);
