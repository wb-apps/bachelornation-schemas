...
export default class QuoteBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:quote-block:1-0-0', QuoteBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:quote-block', QuoteBlockV1);
