...
export default class DocumentBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:document-block:1-0-0', DocumentBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:document-block', DocumentBlockV1);
