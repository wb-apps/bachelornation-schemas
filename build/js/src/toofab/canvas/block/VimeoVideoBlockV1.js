...
export default class VimeoVideoBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:vimeo-video-block:1-0-0', VimeoVideoBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:vimeo-video-block', VimeoVideoBlockV1);
