...
export default class VideoBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:video-block:1-0-0', VideoBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:video-block', VideoBlockV1);
