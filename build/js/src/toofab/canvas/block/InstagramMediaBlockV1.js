...
export default class InstagramMediaBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:instagram-media-block:1-0-0', InstagramMediaBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:instagram-media-block', InstagramMediaBlockV1);
