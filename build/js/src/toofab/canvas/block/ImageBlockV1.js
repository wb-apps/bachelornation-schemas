...
export default class ImageBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:image-block:1-0-0', ImageBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:image-block', ImageBlockV1);
