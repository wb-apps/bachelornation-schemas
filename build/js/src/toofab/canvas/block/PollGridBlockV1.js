...
export default class PollGridBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:poll-grid-block:1-0-0', PollGridBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:poll-grid-block', PollGridBlockV1);
