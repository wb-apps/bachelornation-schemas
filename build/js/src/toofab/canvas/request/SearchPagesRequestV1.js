...
export default class SearchPagesRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:request:search-pages-request:1-0-0', SearchPagesRequestV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:request:search-pages-request', SearchPagesRequestV1);
