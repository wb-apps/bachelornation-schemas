...
export default class GetPageRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:request:get-page-request:1-0-0', GetPageRequestV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:request:get-page-request', GetPageRequestV1);
