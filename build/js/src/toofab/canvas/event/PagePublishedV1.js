...
export default class PagePublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:event:page-published:1-0-0', PagePublishedV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:event:page-published', PagePublishedV1);
