...
export default class PageDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:event:page-deleted:1-0-0', PageDeletedV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:event:page-deleted', PageDeletedV1);
