// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/category-teaser/1-0-0.json#
...
export default class CategoryTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:category-teaser:1-0-0', CategoryTeaserV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:category-teaser', CategoryTeaserV1);
