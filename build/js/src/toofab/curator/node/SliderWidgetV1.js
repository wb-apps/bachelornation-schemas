// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/slider-widget/1-0-0.json#
...
export default class SliderWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:slider-widget:1-0-0', SliderWidgetV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:slider-widget', SliderWidgetV1);
