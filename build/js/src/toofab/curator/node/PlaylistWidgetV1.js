// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/playlist-widget/1-0-0.json#
...
export default class PlaylistWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:playlist-widget:1-0-0', PlaylistWidgetV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:playlist-widget', PlaylistWidgetV1);
