// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/timeline-teaser/1-0-0.json#
...
export default class TimelineTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:timeline-teaser:1-0-0', TimelineTeaserV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:timeline-teaser', TimelineTeaserV1);
