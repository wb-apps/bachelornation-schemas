// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/ad-widget/1-0-0.json#
...
export default class AdWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:ad-widget:1-0-0', AdWidgetV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:ad-widget', AdWidgetV1);
