// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/article-teaser/1-0-0.json#
...
export default class ArticleTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:article-teaser:1-0-0', ArticleTeaserV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:article-teaser', ArticleTeaserV1);
