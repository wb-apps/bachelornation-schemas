// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/video-teaser/1-0-0.json#
...
export default class VideoTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:video-teaser:1-0-0', VideoTeaserV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:video-teaser', VideoTeaserV1);
