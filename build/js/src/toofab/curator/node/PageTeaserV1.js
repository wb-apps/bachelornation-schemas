// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/page-teaser/1-0-0.json#
...
export default class PageTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:page-teaser:1-0-0', PageTeaserV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:page-teaser', PageTeaserV1);
