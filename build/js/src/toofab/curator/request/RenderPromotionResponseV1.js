...
export default class RenderPromotionResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:request:render-promotion-response:1-0-0', RenderPromotionResponseV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:request:render-promotion-response', RenderPromotionResponseV1);
