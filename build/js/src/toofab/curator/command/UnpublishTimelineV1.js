...
export default class UnpublishTimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:command:unpublish-timeline:1-0-0', UnpublishTimelineV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:command:unpublish-timeline', UnpublishTimelineV1);
