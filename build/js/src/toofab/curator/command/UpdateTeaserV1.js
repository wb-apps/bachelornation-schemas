...
export default class UpdateTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:command:update-teaser:1-0-0', UpdateTeaserV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:command:update-teaser', UpdateTeaserV1);
