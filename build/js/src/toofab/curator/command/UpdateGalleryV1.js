...
export default class UpdateGalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:command:update-gallery:1-0-0', UpdateGalleryV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:command:update-gallery', UpdateGalleryV1);
