...
export default class MarkTeaserAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:command:mark-teaser-as-draft:1-0-0', MarkTeaserAsDraftV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:command:mark-teaser-as-draft', MarkTeaserAsDraftV1);
