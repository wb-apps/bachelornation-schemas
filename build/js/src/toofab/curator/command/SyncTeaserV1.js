...
export default class SyncTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:command:sync-teaser:1-0-0', SyncTeaserV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:command:sync-teaser', SyncTeaserV1);
