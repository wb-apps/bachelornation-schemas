...
export default class PublishTimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:command:publish-timeline:1-0-0', PublishTimelineV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:command:publish-timeline', PublishTimelineV1);
