...
export default class MarkTimelineAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:command:mark-timeline-as-draft:1-0-0', MarkTimelineAsDraftV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:command:mark-timeline-as-draft', MarkTimelineAsDraftV1);
