...
export default class TimelineDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:event:timeline-deleted:1-0-0', TimelineDeletedV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:event:timeline-deleted', TimelineDeletedV1);
