...
export default class TeaserExpiredV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:event:teaser-expired:1-0-0', TeaserExpiredV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:event:teaser-expired', TeaserExpiredV1);
