...
export default class PromotionPublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:event:promotion-published:1-0-0', PromotionPublishedV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:event:promotion-published', PromotionPublishedV1);
