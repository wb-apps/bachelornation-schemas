...
export default class PromotionCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:event:promotion-created:1-0-0', PromotionCreatedV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:event:promotion-created', PromotionCreatedV1);
