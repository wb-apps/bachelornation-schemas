...
export default class ArticleExpiredV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:news:event:article-expired:1-0-0', ArticleExpiredV1,
      [],
      [
...
MessageResolver.register('bachelornation:news:event:article-expired', ArticleExpiredV1);
