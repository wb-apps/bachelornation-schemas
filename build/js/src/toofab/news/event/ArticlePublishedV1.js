...
export default class ArticlePublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:news:event:article-published:1-0-0', ArticlePublishedV1,
      [],
      [
...
MessageResolver.register('bachelornation:news:event:article-published', ArticlePublishedV1);
