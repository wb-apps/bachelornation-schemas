...
export default class ArticleRenamedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:news:event:article-renamed:1-0-0', ArticleRenamedV1,
      [],
      [
...
MessageResolver.register('bachelornation:news:event:article-renamed', ArticleRenamedV1);
