...
export default class RemoveArticleSlottingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:news:command:remove-article-slotting:1-0-0', RemoveArticleSlottingV1,
      [],
      [
...
MessageResolver.register('bachelornation:news:command:remove-article-slotting', RemoveArticleSlottingV1);
