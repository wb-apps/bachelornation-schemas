...
export default class LockArticleV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:news:command:lock-article:1-0-0', LockArticleV1,
      [],
      [
...
MessageResolver.register('bachelornation:news:command:lock-article', LockArticleV1);
