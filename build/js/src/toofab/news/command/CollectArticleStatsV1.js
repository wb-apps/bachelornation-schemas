...
export default class CollectArticleStatsV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:news:command:collect-article-stats:1-0-0', CollectArticleStatsV1,
      [],
      [
...
MessageResolver.register('bachelornation:news:command:collect-article-stats', CollectArticleStatsV1);
