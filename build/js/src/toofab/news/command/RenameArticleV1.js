...
export default class RenameArticleV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:news:command:rename-article:1-0-0', RenameArticleV1,
      [],
      [
...
MessageResolver.register('bachelornation:news:command:rename-article', RenameArticleV1);
