...
export default class PublishArticleV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:news:command:publish-article:1-0-0', PublishArticleV1,
      [],
      [
...
MessageResolver.register('bachelornation:news:command:publish-article', PublishArticleV1);
