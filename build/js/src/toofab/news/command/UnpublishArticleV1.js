...
export default class UnpublishArticleV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:news:command:unpublish-article:1-0-0', UnpublishArticleV1,
      [],
      [
...
MessageResolver.register('bachelornation:news:command:unpublish-article', UnpublishArticleV1);
