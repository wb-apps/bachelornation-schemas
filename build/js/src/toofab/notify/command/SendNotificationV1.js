...
export default class SendNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:notify:command:send-notification:1-0-0', SendNotificationV1,
      [],
      [
...
MessageResolver.register('bachelornation:notify:command:send-notification', SendNotificationV1);
