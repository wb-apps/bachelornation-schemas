// @link https://schemas.bachelornation.com/json-schema/bachelornation/notify/node/ios-notification/1-0-0.json#
...
export default class IosNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:notify:node:ios-notification:1-0-0', IosNotificationV1,
      [],
      [
...
MessageResolver.register('bachelornation:notify:node:ios-notification', IosNotificationV1);
