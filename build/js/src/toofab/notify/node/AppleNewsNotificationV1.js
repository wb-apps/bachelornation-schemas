// @link https://schemas.bachelornation.com/json-schema/bachelornation/notify/node/apple-news-notification/1-0-0.json#
...
export default class AppleNewsNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:notify:node:apple-news-notification:1-0-0', AppleNewsNotificationV1,
      [],
      [
...
MessageResolver.register('bachelornation:notify:node:apple-news-notification', AppleNewsNotificationV1);
