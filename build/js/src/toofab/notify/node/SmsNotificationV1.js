// @link https://schemas.bachelornation.com/json-schema/bachelornation/notify/node/sms-notification/1-0-0.json#
...
export default class SmsNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:notify:node:sms-notification:1-0-0', SmsNotificationV1,
      [],
      [
...
MessageResolver.register('bachelornation:notify:node:sms-notification', SmsNotificationV1);
