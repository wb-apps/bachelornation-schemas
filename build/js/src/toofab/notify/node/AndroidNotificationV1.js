// @link https://schemas.bachelornation.com/json-schema/bachelornation/notify/node/android-notification/1-0-0.json#
...
export default class AndroidNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:notify:node:android-notification:1-0-0', AndroidNotificationV1,
      [],
      [
...
MessageResolver.register('bachelornation:notify:node:android-notification', AndroidNotificationV1);
