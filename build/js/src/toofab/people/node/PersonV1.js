// @link https://schemas.bachelornation.com/json-schema/bachelornation/people/node/person/1-0-0.json#
...
export default class PersonV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:people:node:person:1-0-0', PersonV1,
      [],
      [
...
MessageResolver.register('bachelornation:people:node:person', PersonV1);
