// @link https://schemas.bachelornation.com/json-schema/bachelornation/iam/node/sms-app/1-0-0.json#
...
export default class SmsAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:node:sms-app:1-0-0', SmsAppV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:node:sms-app', SmsAppV1);
