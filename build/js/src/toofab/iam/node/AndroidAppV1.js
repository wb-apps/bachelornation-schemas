// @link https://schemas.bachelornation.com/json-schema/bachelornation/iam/node/android-app/1-0-0.json#
...
export default class AndroidAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:node:android-app:1-0-0', AndroidAppV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:node:android-app', AndroidAppV1);
