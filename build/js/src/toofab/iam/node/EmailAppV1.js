// @link https://schemas.bachelornation.com/json-schema/bachelornation/iam/node/email-app/1-0-0.json#
...
export default class EmailAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:node:email-app:1-0-0', EmailAppV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:node:email-app', EmailAppV1);
