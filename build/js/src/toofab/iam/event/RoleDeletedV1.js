...
export default class RoleDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:event:role-deleted:1-0-0', RoleDeletedV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:event:role-deleted', RoleDeletedV1);
