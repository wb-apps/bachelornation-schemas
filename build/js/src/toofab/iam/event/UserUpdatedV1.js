...
export default class UserUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:event:user-updated:1-0-0', UserUpdatedV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:event:user-updated', UserUpdatedV1);
