...
export default class UserRolesGrantedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:event:user-roles-granted:1-0-0', UserRolesGrantedV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:event:user-roles-granted', UserRolesGrantedV1);
