...
export default class AppCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:event:app-created:1-0-0', AppCreatedV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:event:app-created', AppCreatedV1);
