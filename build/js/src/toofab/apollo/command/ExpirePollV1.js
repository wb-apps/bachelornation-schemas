...
export default class ExpirePollV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:apollo:command:expire-poll:1-0-0', ExpirePollV1,
      [],
      [
...
MessageResolver.register('bachelornation:apollo:command:expire-poll', ExpirePollV1);
