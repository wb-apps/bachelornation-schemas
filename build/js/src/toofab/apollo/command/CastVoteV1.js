...
export default class CastVoteV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:apollo:command:cast-vote:1-0-0', CastVoteV1,
      [],
      [
...
MessageResolver.register('bachelornation:apollo:command:cast-vote', CastVoteV1);
