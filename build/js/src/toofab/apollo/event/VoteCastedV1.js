...
export default class VoteCastedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:apollo:event:vote-casted:1-0-0', VoteCastedV1,
      [],
      [
...
MessageResolver.register('bachelornation:apollo:event:vote-casted', VoteCastedV1);
