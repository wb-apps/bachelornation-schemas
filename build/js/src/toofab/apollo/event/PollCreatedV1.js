...
export default class PollCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:apollo:event:poll-created:1-0-0', PollCreatedV1,
      [],
      [
...
MessageResolver.register('bachelornation:apollo:event:poll-created', PollCreatedV1);
