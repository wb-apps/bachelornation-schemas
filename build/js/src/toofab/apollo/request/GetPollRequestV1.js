...
export default class GetPollRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:apollo:request:get-poll-request:1-0-0', GetPollRequestV1,
      [],
      [
...
MessageResolver.register('bachelornation:apollo:request:get-poll-request', GetPollRequestV1);
