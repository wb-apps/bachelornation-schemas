...
export default class DocumentAssetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:dam:node:document-asset:1-0-0', DocumentAssetV1,
      [],
      [
...
MessageResolver.register('bachelornation:dam:node:document-asset', DocumentAssetV1);
