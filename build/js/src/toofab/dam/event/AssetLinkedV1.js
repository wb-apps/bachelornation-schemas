...
export default class AssetLinkedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:dam:event:asset-linked:1-0-0', AssetLinkedV1,
      [],
      [
...
MessageResolver.register('bachelornation:dam:event:asset-linked', AssetLinkedV1);
