...
export default class UnlinkAssetsV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:dam:command:unlink-assets:1-0-0', UnlinkAssetsV1,
      [],
      [
...
MessageResolver.register('bachelornation:dam:command:unlink-assets', UnlinkAssetsV1);
