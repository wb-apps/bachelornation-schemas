...
export default class RenameVideoV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:ovp:command:rename-video:1-0-0', RenameVideoV1,
      [],
      [
...
MessageResolver.register('bachelornation:ovp:command:rename-video', RenameVideoV1);
