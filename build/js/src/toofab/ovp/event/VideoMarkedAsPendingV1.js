...
export default class VideoMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:ovp:event:video-marked-as-pending:1-0-0', VideoMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('bachelornation:ovp:event:video-marked-as-pending', VideoMarkedAsPendingV1);
