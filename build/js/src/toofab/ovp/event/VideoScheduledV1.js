...
export default class VideoScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:ovp:event:video-scheduled:1-0-0', VideoScheduledV1,
      [],
      [
...
MessageResolver.register('bachelornation:ovp:event:video-scheduled', VideoScheduledV1);
