...
export default class UserCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:event:user-created:1-0-0', UserCreatedV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:event:user-created', UserCreatedV1);
