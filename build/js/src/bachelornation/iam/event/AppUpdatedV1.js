...
export default class AppUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:event:app-updated:1-0-0', AppUpdatedV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:event:app-updated', AppUpdatedV1);
