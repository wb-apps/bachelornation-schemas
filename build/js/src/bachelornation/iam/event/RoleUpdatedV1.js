...
export default class RoleUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:event:role-updated:1-0-0', RoleUpdatedV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:event:role-updated', RoleUpdatedV1);
