...
export default class RoleCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:event:role-created:1-0-0', RoleCreatedV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:event:role-created', RoleCreatedV1);
