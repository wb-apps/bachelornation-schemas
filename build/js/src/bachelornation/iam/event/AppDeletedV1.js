...
export default class AppDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:event:app-deleted:1-0-0', AppDeletedV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:event:app-deleted', AppDeletedV1);
