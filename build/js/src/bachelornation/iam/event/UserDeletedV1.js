...
export default class UserDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:event:user-deleted:1-0-0', UserDeletedV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:event:user-deleted', UserDeletedV1);
