...
export default class AppleNewsAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:node:apple-news-app:1-0-0', AppleNewsAppV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:node:apple-news-app', AppleNewsAppV1);
