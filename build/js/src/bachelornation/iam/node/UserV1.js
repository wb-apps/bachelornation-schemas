// @link https://schemas.bachelornation.com/json-schema/bachelornation/iam/node/user/1-0-0.json#
...
export default class UserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:node:user:1-0-0', UserV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:node:user', UserV1);
