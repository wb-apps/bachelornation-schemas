// @link https://schemas.bachelornation.com/json-schema/bachelornation/iam/node/alexa-app/1-0-0.json#
...
export default class AlexaAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:node:alexa-app:1-0-0', AlexaAppV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:node:alexa-app', AlexaAppV1);
