// @link https://schemas.bachelornation.com/json-schema/bachelornation/iam/node/browser-app/1-0-0.json#
...
export default class BrowserAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:node:browser-app:1-0-0', BrowserAppV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:node:browser-app', BrowserAppV1);
