// @link https://schemas.bachelornation.com/json-schema/bachelornation/iam/node/twitter-app/1-0-0.json#
...
export default class TwitterAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:node:twitter-app:1-0-0', TwitterAppV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:node:twitter-app', TwitterAppV1);
