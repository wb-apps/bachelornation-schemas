// @link https://schemas.bachelornation.com/json-schema/bachelornation/iam/node/ios-app/1-0-0.json#
...
export default class IosAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:node:ios-app:1-0-0', IosAppV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:node:ios-app', IosAppV1);
