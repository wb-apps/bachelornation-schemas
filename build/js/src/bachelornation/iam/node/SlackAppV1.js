// @link https://schemas.bachelornation.com/json-schema/bachelornation/iam/node/slack-app/1-0-0.json#
...
export default class SlackAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:node:slack-app:1-0-0', SlackAppV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:node:slack-app', SlackAppV1);
