// @link https://schemas.bachelornation.com/json-schema/bachelornation/iam/command/delete-role/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:bachelornation:iam:command:delete-role:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'bachelornation:iam:command:delete-role';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'bachelornation:iam:command:delete-role:v1';
