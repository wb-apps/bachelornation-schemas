...
export default class GrantRolesToUserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:command:grant-roles-to-user:1-0-0', GrantRolesToUserV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:command:grant-roles-to-user', GrantRolesToUserV1);
