// @link https://schemas.bachelornation.com/json-schema/bachelornation/iam/command/create-app/1-0-0.json#
...
const M = CreateAppV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:bachelornation:iam:command:create-app:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'bachelornation:iam:command:create-app';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'bachelornation:iam:command:create-app:v1';
