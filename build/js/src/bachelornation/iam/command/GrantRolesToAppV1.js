...
export default class GrantRolesToAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:command:grant-roles-to-app:1-0-0', GrantRolesToAppV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:command:grant-roles-to-app', GrantRolesToAppV1);
