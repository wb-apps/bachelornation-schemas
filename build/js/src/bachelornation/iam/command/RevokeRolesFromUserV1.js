...
export default class RevokeRolesFromUserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:command:revoke-roles-from-user:1-0-0', RevokeRolesFromUserV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:command:revoke-roles-from-user', RevokeRolesFromUserV1);
