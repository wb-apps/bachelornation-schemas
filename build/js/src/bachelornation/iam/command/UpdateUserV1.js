...
export default class UpdateUserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:command:update-user:1-0-0', UpdateUserV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:command:update-user', UpdateUserV1);
