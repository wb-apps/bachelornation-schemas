// @link https://schemas.bachelornation.com/json-schema/bachelornation/iam/command/update-user/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:bachelornation:iam:command:update-user:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'bachelornation:iam:command:update-user';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'bachelornation:iam:command:update-user:v1';
