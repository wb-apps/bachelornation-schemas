...
export default class GetUserHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:request:get-user-history-response:1-0-0', GetUserHistoryResponseV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:request:get-user-history-response', GetUserHistoryResponseV1);
