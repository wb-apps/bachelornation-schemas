...
export default class ListAllRolesResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:request:list-all-roles-response:1-0-0', ListAllRolesResponseV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:request:list-all-roles-response', ListAllRolesResponseV1);
