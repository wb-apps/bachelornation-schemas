...
export default class GetAppRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:request:get-app-request:1-0-0', GetAppRequestV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:request:get-app-request', GetAppRequestV1);
