...
export default class SearchUsersRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:request:search-users-request:1-0-0', SearchUsersRequestV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:request:search-users-request', SearchUsersRequestV1);
