...
export default class GetAllAppsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:request:get-all-apps-request:1-0-0', GetAllAppsRequestV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:request:get-all-apps-request', GetAllAppsRequestV1);
