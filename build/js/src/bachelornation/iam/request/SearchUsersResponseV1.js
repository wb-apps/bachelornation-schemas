...
export default class SearchUsersResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:request:search-users-response:1-0-0', SearchUsersResponseV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:request:search-users-response', SearchUsersResponseV1);
