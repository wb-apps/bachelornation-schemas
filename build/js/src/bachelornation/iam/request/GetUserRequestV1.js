...
export default class GetUserRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:iam:request:get-user-request:1-0-0', GetUserRequestV1,
      [],
      [
...
MessageResolver.register('bachelornation:iam:request:get-user-request', GetUserRequestV1);
