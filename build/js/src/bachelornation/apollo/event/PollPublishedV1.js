...
export default class PollPublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:apollo:event:poll-published:1-0-0', PollPublishedV1,
      [],
      [
...
MessageResolver.register('bachelornation:apollo:event:poll-published', PollPublishedV1);
