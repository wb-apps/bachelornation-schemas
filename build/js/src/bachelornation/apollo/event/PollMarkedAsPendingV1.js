...
export default class PollMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:apollo:event:poll-marked-as-pending:1-0-0', PollMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('bachelornation:apollo:event:poll-marked-as-pending', PollMarkedAsPendingV1);
