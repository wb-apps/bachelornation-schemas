...
export default class PollExpiredV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:apollo:event:poll-expired:1-0-0', PollExpiredV1,
      [],
      [
...
MessageResolver.register('bachelornation:apollo:event:poll-expired', PollExpiredV1);
