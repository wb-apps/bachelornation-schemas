...
export default class PollMarkedAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:apollo:event:poll-marked-as-draft:1-0-0', PollMarkedAsDraftV1,
      [],
      [
...
MessageResolver.register('bachelornation:apollo:event:poll-marked-as-draft', PollMarkedAsDraftV1);
