...
export default class UnpublishPollV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:apollo:command:unpublish-poll:1-0-0', UnpublishPollV1,
      [],
      [
...
MessageResolver.register('bachelornation:apollo:command:unpublish-poll', UnpublishPollV1);
