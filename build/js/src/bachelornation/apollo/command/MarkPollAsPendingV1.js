...
export default class MarkPollAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:apollo:command:mark-poll-as-pending:1-0-0', MarkPollAsPendingV1,
      [],
      [
...
MessageResolver.register('bachelornation:apollo:command:mark-poll-as-pending', MarkPollAsPendingV1);
