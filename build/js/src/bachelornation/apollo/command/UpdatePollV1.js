...
export default class UpdatePollV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:apollo:command:update-poll:1-0-0', UpdatePollV1,
      [],
      [
...
MessageResolver.register('bachelornation:apollo:command:update-poll', UpdatePollV1);
