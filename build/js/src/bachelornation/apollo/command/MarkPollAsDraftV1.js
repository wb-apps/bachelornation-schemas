...
export default class MarkPollAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:apollo:command:mark-poll-as-draft:1-0-0', MarkPollAsDraftV1,
      [],
      [
...
MessageResolver.register('bachelornation:apollo:command:mark-poll-as-draft', MarkPollAsDraftV1);
