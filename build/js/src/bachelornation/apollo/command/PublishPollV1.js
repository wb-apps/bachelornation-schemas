...
export default class PublishPollV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:apollo:command:publish-poll:1-0-0', PublishPollV1,
      [],
      [
...
MessageResolver.register('bachelornation:apollo:command:publish-poll', PublishPollV1);
