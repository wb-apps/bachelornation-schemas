...
export default class PollStatsV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:apollo:node:poll-stats:1-0-0', PollStatsV1,
      [],
      [
...
MessageResolver.register('bachelornation:apollo:node:poll-stats', PollStatsV1);
