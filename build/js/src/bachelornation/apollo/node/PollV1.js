// @link https://schemas.bachelornation.com/json-schema/bachelornation/apollo/node/poll/1-0-0.json#
...
export default class PollV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:apollo:node:poll:1-0-0', PollV1,
      [],
      [
...
MessageResolver.register('bachelornation:apollo:node:poll', PollV1);
