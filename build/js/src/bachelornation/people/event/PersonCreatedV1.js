...
export default class PersonCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:people:event:person-created:1-0-0', PersonCreatedV1,
      [],
      [
...
MessageResolver.register('bachelornation:people:event:person-created', PersonCreatedV1);
