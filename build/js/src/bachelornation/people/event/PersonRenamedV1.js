...
export default class PersonRenamedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:people:event:person-renamed:1-0-0', PersonRenamedV1,
      [],
      [
...
MessageResolver.register('bachelornation:people:event:person-renamed', PersonRenamedV1);
