// @link https://schemas.bachelornation.com/json-schema/bachelornation/sys/command/update-picklist/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:bachelornation:sys:command:update-picklist:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'bachelornation:sys:command:update-picklist';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'bachelornation:sys:command:update-picklist:v1';
