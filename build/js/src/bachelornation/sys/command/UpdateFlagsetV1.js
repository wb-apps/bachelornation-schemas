...
export default class UpdateFlagsetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:sys:command:update-flagset:1-0-0', UpdateFlagsetV1,
      [],
      [
...
MessageResolver.register('bachelornation:sys:command:update-flagset', UpdateFlagsetV1);
