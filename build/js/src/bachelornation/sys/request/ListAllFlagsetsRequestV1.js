...
export default class ListAllFlagsetsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:sys:request:list-all-flagsets-request:1-0-0', ListAllFlagsetsRequestV1,
      [],
      [
...
MessageResolver.register('bachelornation:sys:request:list-all-flagsets-request', ListAllFlagsetsRequestV1);
