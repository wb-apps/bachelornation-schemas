// @link https://schemas.bachelornation.com/json-schema/bachelornation/sys/request/list-all-flagsets-response/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:bachelornation:sys:request:list-all-flagsets-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'bachelornation:sys:request:list-all-flagsets-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'bachelornation:sys:request:list-all-flagsets-response:v1';
