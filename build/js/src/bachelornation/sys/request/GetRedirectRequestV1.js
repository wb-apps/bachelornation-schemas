...
export default class GetRedirectRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:sys:request:get-redirect-request:1-0-0', GetRedirectRequestV1,
      [],
      [
...
MessageResolver.register('bachelornation:sys:request:get-redirect-request', GetRedirectRequestV1);
