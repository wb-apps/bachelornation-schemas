...
export default class RedirectCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:sys:event:redirect-created:1-0-0', RedirectCreatedV1,
      [],
      [
...
MessageResolver.register('bachelornation:sys:event:redirect-created', RedirectCreatedV1);
