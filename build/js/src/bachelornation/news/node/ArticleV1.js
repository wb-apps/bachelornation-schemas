// @link https://schemas.bachelornation.com/json-schema/bachelornation/news/node/article/1-0-1.json#
...
export default class ArticleV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:news:node:article:1-0-1', ArticleV1,
      [],
      [
