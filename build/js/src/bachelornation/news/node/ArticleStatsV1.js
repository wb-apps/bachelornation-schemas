// @link https://schemas.bachelornation.com/json-schema/bachelornation/news/node/article-stats/1-0-0.json#
...
export default class ArticleStatsV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:news:node:article-stats:1-0-0', ArticleStatsV1,
      [],
      [
...
MessageResolver.register('bachelornation:news:node:article-stats', ArticleStatsV1);
