...
export default class ArticleMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:news:event:article-marked-as-pending:1-0-0', ArticleMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('bachelornation:news:event:article-marked-as-pending', ArticleMarkedAsPendingV1);
