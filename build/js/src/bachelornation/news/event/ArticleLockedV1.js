...
export default class ArticleLockedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:news:event:article-locked:1-0-0', ArticleLockedV1,
      [],
      [
...
MessageResolver.register('bachelornation:news:event:article-locked', ArticleLockedV1);
