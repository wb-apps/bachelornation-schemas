...
export default class ArticleScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:news:event:article-scheduled:1-0-0', ArticleScheduledV1,
      [],
      [
...
MessageResolver.register('bachelornation:news:event:article-scheduled', ArticleScheduledV1);
