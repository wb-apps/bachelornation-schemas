...
export default class ArticleCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:news:event:article-created:1-0-0', ArticleCreatedV1,
      [],
      [
...
MessageResolver.register('bachelornation:news:event:article-created', ArticleCreatedV1);
