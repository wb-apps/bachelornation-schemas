...
export default class ArticleUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:news:event:article-unpublished:1-0-0', ArticleUnpublishedV1,
      [],
      [
...
MessageResolver.register('bachelornation:news:event:article-unpublished', ArticleUnpublishedV1);
