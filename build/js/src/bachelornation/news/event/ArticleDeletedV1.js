...
export default class ArticleDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:news:event:article-deleted:1-0-0', ArticleDeletedV1,
      [],
      [
...
MessageResolver.register('bachelornation:news:event:article-deleted', ArticleDeletedV1);
