...
export default class CategoryDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:taxonomy:event:category-deleted:1-0-0', CategoryDeletedV1,
      [],
      [
...
MessageResolver.register('bachelornation:taxonomy:event:category-deleted', CategoryDeletedV1);
