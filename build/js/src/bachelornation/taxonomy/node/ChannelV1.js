// @link https://schemas.bachelornation.com/json-schema/bachelornation/taxonomy/node/channel/1-0-0.json#
...
export default class ChannelV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:taxonomy:node:channel:1-0-0', ChannelV1,
      [],
      [
...
MessageResolver.register('bachelornation:taxonomy:node:channel', ChannelV1);
