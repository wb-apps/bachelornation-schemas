// @link https://schemas.bachelornation.com/json-schema/bachelornation/taxonomy/node/category/1-0-0.json#
...
export default class CategoryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:taxonomy:node:category:1-0-0', CategoryV1,
      [],
      [
...
MessageResolver.register('bachelornation:taxonomy:node:category', CategoryV1);
