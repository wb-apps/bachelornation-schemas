...
export default class SearchCategoriesRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:taxonomy:request:search-categories-request:1-0-0', SearchCategoriesRequestV1,
      [],
      [
...
MessageResolver.register('bachelornation:taxonomy:request:search-categories-request', SearchCategoriesRequestV1);
