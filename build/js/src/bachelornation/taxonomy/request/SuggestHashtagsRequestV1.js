...
export default class SuggestHashtagsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:taxonomy:request:suggest-hashtags-request:1-0-0', SuggestHashtagsRequestV1,
      [],
      [
...
MessageResolver.register('bachelornation:taxonomy:request:suggest-hashtags-request', SuggestHashtagsRequestV1);
