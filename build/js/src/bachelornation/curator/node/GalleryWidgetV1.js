// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/gallery-widget/1-0-0.json#
...
export default class GalleryWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:gallery-widget:1-0-0', GalleryWidgetV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:gallery-widget', GalleryWidgetV1);
