...
export default class GridlerWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:gridler-widget:1-0-0', GridlerWidgetV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:gridler-widget', GridlerWidgetV1);
