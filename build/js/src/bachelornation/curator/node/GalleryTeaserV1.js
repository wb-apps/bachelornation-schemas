// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/gallery-teaser/1-0-0.json#
...
export default class GalleryTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:gallery-teaser:1-0-0', GalleryTeaserV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:gallery-teaser', GalleryTeaserV1);
