// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/gallery/1-0-0.json#
...
export default class GalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:gallery:1-0-0', GalleryV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:gallery', GalleryV1);
