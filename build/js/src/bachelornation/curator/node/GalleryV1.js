// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/gallery/1-0-1.json#
...
export default class GalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:gallery:1-0-1', GalleryV1,
      [],
      [
