// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/carousel-widget/1-0-0.json#
...
export default class CarouselWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:carousel-widget:1-0-0', CarouselWidgetV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:carousel-widget', CarouselWidgetV1);
