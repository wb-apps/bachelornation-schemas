// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/spotlight-widget/1-0-0.json#
...
export default class SpotlightWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:spotlight-widget:1-0-0', SpotlightWidgetV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:spotlight-widget', SpotlightWidgetV1);
