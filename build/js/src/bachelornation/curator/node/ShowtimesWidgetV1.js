// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/showtimes-widget/1-0-0.json#
...
export default class ShowtimesWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:showtimes-widget:1-0-0', ShowtimesWidgetV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:showtimes-widget', ShowtimesWidgetV1);
