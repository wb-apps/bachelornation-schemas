// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/poll-teaser/1-0-0.json#
...
export default class PollTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:poll-teaser:1-0-0', PollTeaserV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:poll-teaser', PollTeaserV1);
