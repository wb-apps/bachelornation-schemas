// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/tetris-widget/1-0-0.json#
...
export default class TetrisWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:tetris-widget:1-0-0', TetrisWidgetV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:tetris-widget', TetrisWidgetV1);
