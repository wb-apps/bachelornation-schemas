// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/media-list-widget/1-0-0.json#
...
export default class MediaListWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:media-list-widget:1-0-0', MediaListWidgetV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:media-list-widget', MediaListWidgetV1);
