// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/channel-teaser/1-0-0.json#
...
export default class ChannelTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:channel-teaser:1-0-0', ChannelTeaserV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:channel-teaser', ChannelTeaserV1);
