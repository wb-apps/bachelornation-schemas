// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/asset-teaser/1-0-0.json#
...
export default class AssetTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:asset-teaser:1-0-0', AssetTeaserV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:asset-teaser', AssetTeaserV1);
