// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/code-widget/1-0-0.json#
...
export default class CodeWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:code-widget:1-0-0', CodeWidgetV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:code-widget', CodeWidgetV1);
