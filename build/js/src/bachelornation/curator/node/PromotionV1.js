// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/promotion/1-0-0.json#
...
export default class PromotionV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:promotion:1-0-0', PromotionV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:promotion', PromotionV1);
