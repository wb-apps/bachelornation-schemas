// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/blogroll-widget/1-0-0.json#
...
export default class BlogrollWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:blogroll-widget:1-0-0', BlogrollWidgetV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:blogroll-widget', BlogrollWidgetV1);
