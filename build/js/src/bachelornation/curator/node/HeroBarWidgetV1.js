// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/hero-bar-widget/1-0-0.json#
...
export default class HeroBarWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:hero-bar-widget:1-0-0', HeroBarWidgetV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:hero-bar-widget', HeroBarWidgetV1);
