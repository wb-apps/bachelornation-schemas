// @link https://schemas.bachelornation.com/json-schema/bachelornation/curator/node/person-teaser/1-0-0.json#
...
export default class PersonTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:node:person-teaser:1-0-0', PersonTeaserV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:node:person-teaser', PersonTeaserV1);
