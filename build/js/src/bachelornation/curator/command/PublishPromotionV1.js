...
export default class PublishPromotionV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:command:publish-promotion:1-0-0', PublishPromotionV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:command:publish-promotion', PublishPromotionV1);
