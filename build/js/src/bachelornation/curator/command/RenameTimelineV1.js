...
export default class RenameTimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:command:rename-timeline:1-0-0', RenameTimelineV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:command:rename-timeline', RenameTimelineV1);
