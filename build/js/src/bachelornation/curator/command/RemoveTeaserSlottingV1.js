...
export default class RemoveTeaserSlottingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:command:remove-teaser-slotting:1-0-0', RemoveTeaserSlottingV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:command:remove-teaser-slotting', RemoveTeaserSlottingV1);
