...
export default class ExpireGalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:command:expire-gallery:1-0-0', ExpireGalleryV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:command:expire-gallery', ExpireGalleryV1);
