...
export default class UpdateWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:command:update-widget:1-0-0', UpdateWidgetV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:command:update-widget', UpdateWidgetV1);
