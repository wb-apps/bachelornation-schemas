...
export default class UpdateTimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:command:update-timeline:1-0-0', UpdateTimelineV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:command:update-timeline', UpdateTimelineV1);
