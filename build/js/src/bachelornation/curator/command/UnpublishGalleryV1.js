...
export default class UnpublishGalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:command:unpublish-gallery:1-0-0', UnpublishGalleryV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:command:unpublish-gallery', UnpublishGalleryV1);
