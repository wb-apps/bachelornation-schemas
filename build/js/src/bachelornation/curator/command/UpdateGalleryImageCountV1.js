...
export default class UpdateGalleryImageCountV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:command:update-gallery-image-count:1-0-0', UpdateGalleryImageCountV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:command:update-gallery-image-count', UpdateGalleryImageCountV1);
