...
export default class TeaserPublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:event:teaser-published:1-0-0', TeaserPublishedV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:event:teaser-published', TeaserPublishedV1);
