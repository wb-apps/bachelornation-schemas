...
export default class TeaserSlottingRemovedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:event:teaser-slotting-removed:1-0-0', TeaserSlottingRemovedV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:event:teaser-slotting-removed', TeaserSlottingRemovedV1);
