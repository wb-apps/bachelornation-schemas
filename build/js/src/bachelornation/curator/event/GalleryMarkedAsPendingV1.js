...
export default class GalleryMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:event:gallery-marked-as-pending:1-0-0', GalleryMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:event:gallery-marked-as-pending', GalleryMarkedAsPendingV1);
