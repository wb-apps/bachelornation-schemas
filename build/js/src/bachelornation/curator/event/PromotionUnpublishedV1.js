...
export default class PromotionUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:event:promotion-unpublished:1-0-0', PromotionUnpublishedV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:event:promotion-unpublished', PromotionUnpublishedV1);
