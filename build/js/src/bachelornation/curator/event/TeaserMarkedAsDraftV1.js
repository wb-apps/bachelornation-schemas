...
export default class TeaserMarkedAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:event:teaser-marked-as-draft:1-0-0', TeaserMarkedAsDraftV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:event:teaser-marked-as-draft', TeaserMarkedAsDraftV1);
