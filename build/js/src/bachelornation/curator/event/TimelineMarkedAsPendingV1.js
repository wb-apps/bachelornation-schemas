...
export default class TimelineMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:event:timeline-marked-as-pending:1-0-0', TimelineMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:event:timeline-marked-as-pending', TimelineMarkedAsPendingV1);
