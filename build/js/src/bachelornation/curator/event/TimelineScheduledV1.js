...
export default class TimelineScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:event:timeline-scheduled:1-0-0', TimelineScheduledV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:event:timeline-scheduled', TimelineScheduledV1);
