...
export default class GetPromotionRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:request:get-promotion-request:1-0-0', GetPromotionRequestV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:request:get-promotion-request', GetPromotionRequestV1);
