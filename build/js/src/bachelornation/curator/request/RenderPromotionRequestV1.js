...
export default class RenderPromotionRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:request:render-promotion-request:1-0-0', RenderPromotionRequestV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:request:render-promotion-request', RenderPromotionRequestV1);
