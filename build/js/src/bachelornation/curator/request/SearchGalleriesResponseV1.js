...
export default class SearchGalleriesResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:request:search-galleries-response:1-0-0', SearchGalleriesResponseV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:request:search-galleries-response', SearchGalleriesResponseV1);
