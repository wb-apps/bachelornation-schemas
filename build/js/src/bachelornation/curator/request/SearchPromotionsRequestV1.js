...
export default class SearchPromotionsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:request:search-promotions-request:1-0-0', SearchPromotionsRequestV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:request:search-promotions-request', SearchPromotionsRequestV1);
