...
export default class SearchTimelinesResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:request:search-timelines-response:1-0-0', SearchTimelinesResponseV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:request:search-timelines-response', SearchTimelinesResponseV1);
