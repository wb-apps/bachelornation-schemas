...
export default class SearchWidgetsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:request:search-widgets-request:1-0-0', SearchWidgetsRequestV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:request:search-widgets-request', SearchWidgetsRequestV1);
