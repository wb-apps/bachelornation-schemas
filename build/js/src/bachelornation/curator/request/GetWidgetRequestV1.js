...
export default class GetWidgetRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:curator:request:get-widget-request:1-0-0', GetWidgetRequestV1,
      [],
      [
...
MessageResolver.register('bachelornation:curator:request:get-widget-request', GetWidgetRequestV1);
