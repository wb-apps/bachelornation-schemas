...
export default class UnknownAssetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:dam:node:unknown-asset:1-0-0', UnknownAssetV1,
      [],
      [
...
MessageResolver.register('bachelornation:dam:node:unknown-asset', UnknownAssetV1);
