...
export default class ArchiveAssetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:dam:node:archive-asset:1-0-0', ArchiveAssetV1,
      [],
      [
...
MessageResolver.register('bachelornation:dam:node:archive-asset', ArchiveAssetV1);
