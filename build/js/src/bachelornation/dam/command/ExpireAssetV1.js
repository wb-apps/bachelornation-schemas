...
export default class ExpireAssetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:dam:command:expire-asset:1-0-0', ExpireAssetV1,
      [],
      [
...
MessageResolver.register('bachelornation:dam:command:expire-asset', ExpireAssetV1);
