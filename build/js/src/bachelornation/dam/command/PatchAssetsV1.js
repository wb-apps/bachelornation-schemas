...
export default class PatchAssetsV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:dam:command:patch-assets:1-0-0', PatchAssetsV1,
      [],
      [
...
MessageResolver.register('bachelornation:dam:command:patch-assets', PatchAssetsV1);
