...
export default class LinkAssetsV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:dam:command:link-assets:1-0-0', LinkAssetsV1,
      [],
      [
...
MessageResolver.register('bachelornation:dam:command:link-assets', LinkAssetsV1);
