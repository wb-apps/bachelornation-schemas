...
export default class UpdateAssetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:dam:command:update-asset:1-0-0', UpdateAssetV1,
      [],
      [
...
MessageResolver.register('bachelornation:dam:command:update-asset', UpdateAssetV1);
