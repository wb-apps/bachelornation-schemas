...
export default class ReorderGalleryAssetsV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:dam:command:reorder-gallery-assets:1-0-0', ReorderGalleryAssetsV1,
      [],
      [
...
MessageResolver.register('bachelornation:dam:command:reorder-gallery-assets', ReorderGalleryAssetsV1);
