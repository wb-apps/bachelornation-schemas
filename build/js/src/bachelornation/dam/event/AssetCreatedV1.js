...
export default class AssetCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:dam:event:asset-created:1-0-0', AssetCreatedV1,
      [],
      [
...
MessageResolver.register('bachelornation:dam:event:asset-created', AssetCreatedV1);
