...
export default class AssetPatchedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:dam:event:asset-patched:1-0-0', AssetPatchedV1,
      [],
      [
...
MessageResolver.register('bachelornation:dam:event:asset-patched', AssetPatchedV1);
