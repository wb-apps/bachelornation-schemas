...
export default class AssetExpiredV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:dam:event:asset-expired:1-0-0', AssetExpiredV1,
      [],
      [
...
MessageResolver.register('bachelornation:dam:event:asset-expired', AssetExpiredV1);
