...
export default class AssetDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:dam:event:asset-deleted:1-0-0', AssetDeletedV1,
      [],
      [
...
MessageResolver.register('bachelornation:dam:event:asset-deleted', AssetDeletedV1);
