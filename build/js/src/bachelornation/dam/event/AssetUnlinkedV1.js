...
export default class AssetUnlinkedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:dam:event:asset-unlinked:1-0-0', AssetUnlinkedV1,
      [],
      [
...
MessageResolver.register('bachelornation:dam:event:asset-unlinked', AssetUnlinkedV1);
