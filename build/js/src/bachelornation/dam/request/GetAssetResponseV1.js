...
export default class GetAssetResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:dam:request:get-asset-response:1-0-0', GetAssetResponseV1,
      [],
      [
...
MessageResolver.register('bachelornation:dam:request:get-asset-response', GetAssetResponseV1);
