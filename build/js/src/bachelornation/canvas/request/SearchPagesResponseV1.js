...
export default class SearchPagesResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:request:search-pages-response:1-0-0', SearchPagesResponseV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:request:search-pages-response', SearchPagesResponseV1);
