...
export default class IframeBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:iframe-block:1-0-0', IframeBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:iframe-block', IframeBlockV1);
