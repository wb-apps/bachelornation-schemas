...
export default class PinterestPinBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:pinterest-pin-block:1-0-0', PinterestPinBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:pinterest-pin-block', PinterestPinBlockV1);
