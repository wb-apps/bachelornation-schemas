...
export default class TwitterTweetBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:twitter-tweet-block:1-0-0', TwitterTweetBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:twitter-tweet-block', TwitterTweetBlockV1);
