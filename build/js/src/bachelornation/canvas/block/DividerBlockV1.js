...
export default class DividerBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:divider-block:1-0-0', DividerBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:divider-block', DividerBlockV1);
