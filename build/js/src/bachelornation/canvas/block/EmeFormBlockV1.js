...
export default class EmeFormBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:eme-form-block:1-0-0', EmeFormBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:eme-form-block', EmeFormBlockV1);
