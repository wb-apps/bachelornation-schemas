...
export default class GalleryBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:gallery-block:1-0-0', GalleryBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:gallery-block', GalleryBlockV1);
