...
export default class TumblrPostBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:tumblr-post-block:1-0-0', TumblrPostBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:tumblr-post-block', TumblrPostBlockV1);
