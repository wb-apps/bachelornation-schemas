...
export default class TextBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:text-block:1-0-0', TextBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:text-block', TextBlockV1);
