...
export default class YoutubePlaylistBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:youtube-playlist-block:1-0-0', YoutubePlaylistBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:youtube-playlist-block', YoutubePlaylistBlockV1);
