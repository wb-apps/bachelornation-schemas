...
export default class SpotifyTrackBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:spotify-track-block:1-0-0', SpotifyTrackBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:spotify-track-block', SpotifyTrackBlockV1);
