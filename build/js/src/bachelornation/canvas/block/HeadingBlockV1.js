...
export default class HeadingBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:heading-block:1-0-0', HeadingBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:heading-block', HeadingBlockV1);
