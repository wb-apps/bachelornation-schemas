...
export default class CodeBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:code-block:1-0-0', CodeBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:code-block', CodeBlockV1);
