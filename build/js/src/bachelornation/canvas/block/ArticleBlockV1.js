...
export default class ArticleBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:article-block:1-0-0', ArticleBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:article-block', ArticleBlockV1);
