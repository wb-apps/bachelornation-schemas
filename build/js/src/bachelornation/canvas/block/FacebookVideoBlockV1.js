...
export default class FacebookVideoBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:block:facebook-video-block:1-0-0', FacebookVideoBlockV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:block:facebook-video-block', FacebookVideoBlockV1);
