// @link https://schemas.bachelornation.com/json-schema/bachelornation/canvas/node/page/1-0-0.json#
...
export default class PageV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:node:page:1-0-0', PageV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:node:page', PageV1);
