...
export default class PageCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:event:page-created:1-0-0', PageCreatedV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:event:page-created', PageCreatedV1);
