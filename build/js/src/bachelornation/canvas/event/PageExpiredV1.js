...
export default class PageExpiredV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:event:page-expired:1-0-0', PageExpiredV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:event:page-expired', PageExpiredV1);
