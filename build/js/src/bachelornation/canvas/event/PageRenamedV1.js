...
export default class PageRenamedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:event:page-renamed:1-0-0', PageRenamedV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:event:page-renamed', PageRenamedV1);
