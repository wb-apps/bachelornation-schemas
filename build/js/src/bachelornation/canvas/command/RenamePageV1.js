...
export default class RenamePageV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:command:rename-page:1-0-0', RenamePageV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:command:rename-page', RenamePageV1);
