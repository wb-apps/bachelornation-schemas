// @link https://schemas.bachelornation.com/json-schema/bachelornation/canvas/command/publish-page/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:bachelornation:canvas:command:publish-page:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'bachelornation:canvas:command:publish-page';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:command:publish-page:v1';
