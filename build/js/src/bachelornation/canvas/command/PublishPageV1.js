...
export default class PublishPageV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:canvas:command:publish-page:1-0-0', PublishPageV1,
      [],
      [
...
MessageResolver.register('bachelornation:canvas:command:publish-page', PublishPageV1);
