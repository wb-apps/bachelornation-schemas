...
export default class GetSponsorRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:boost:request:get-sponsor-request:1-0-0', GetSponsorRequestV1,
      [],
      [
...
MessageResolver.register('bachelornation:boost:request:get-sponsor-request', GetSponsorRequestV1);
