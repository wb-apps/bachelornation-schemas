...
export default class SearchSponsorsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:boost:request:search-sponsors-request:1-0-0', SearchSponsorsRequestV1,
      [],
      [
...
MessageResolver.register('bachelornation:boost:request:search-sponsors-request', SearchSponsorsRequestV1);
