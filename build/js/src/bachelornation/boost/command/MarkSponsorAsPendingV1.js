...
export default class MarkSponsorAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:boost:command:mark-sponsor-as-pending:1-0-0', MarkSponsorAsPendingV1,
      [],
      [
...
MessageResolver.register('bachelornation:boost:command:mark-sponsor-as-pending', MarkSponsorAsPendingV1);
