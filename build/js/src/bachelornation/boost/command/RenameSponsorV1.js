...
export default class RenameSponsorV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:boost:command:rename-sponsor:1-0-0', RenameSponsorV1,
      [],
      [
...
MessageResolver.register('bachelornation:boost:command:rename-sponsor', RenameSponsorV1);
