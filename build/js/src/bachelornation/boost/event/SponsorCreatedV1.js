...
export default class SponsorCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:boost:event:sponsor-created:1-0-0', SponsorCreatedV1,
      [],
      [
...
MessageResolver.register('bachelornation:boost:event:sponsor-created', SponsorCreatedV1);
