...
export default class SponsorUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:boost:event:sponsor-unpublished:1-0-0', SponsorUnpublishedV1,
      [],
      [
...
MessageResolver.register('bachelornation:boost:event:sponsor-unpublished', SponsorUnpublishedV1);
