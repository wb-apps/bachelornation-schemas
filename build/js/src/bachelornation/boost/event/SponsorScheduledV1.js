...
export default class SponsorScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:boost:event:sponsor-scheduled:1-0-0', SponsorScheduledV1,
      [],
      [
...
MessageResolver.register('bachelornation:boost:event:sponsor-scheduled', SponsorScheduledV1);
