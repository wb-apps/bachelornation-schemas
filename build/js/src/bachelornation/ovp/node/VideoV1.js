// @link https://schemas.bachelornation.com/json-schema/bachelornation/ovp/node/video/1-0-1.json#
...
export default class VideoV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:ovp:node:video:1-0-1', VideoV1,
      [],
      [
