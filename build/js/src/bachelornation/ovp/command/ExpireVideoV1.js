...
export default class ExpireVideoV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:ovp:command:expire-video:1-0-0', ExpireVideoV1,
      [],
      [
...
MessageResolver.register('bachelornation:ovp:command:expire-video', ExpireVideoV1);
