...
export default class UpdateVideoV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:ovp:command:update-video:1-0-0', UpdateVideoV1,
      [],
      [
...
MessageResolver.register('bachelornation:ovp:command:update-video', UpdateVideoV1);
