...
export default class PublishVideoV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:ovp:command:publish-video:1-0-0', PublishVideoV1,
      [],
      [
...
MessageResolver.register('bachelornation:ovp:command:publish-video', PublishVideoV1);
