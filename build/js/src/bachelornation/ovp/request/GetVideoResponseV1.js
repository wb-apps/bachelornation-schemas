...
export default class GetVideoResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:ovp:request:get-video-response:1-0-0', GetVideoResponseV1,
      [],
      [
...
MessageResolver.register('bachelornation:ovp:request:get-video-response', GetVideoResponseV1);
