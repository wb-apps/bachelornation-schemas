...
export default class VideoRenamedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:ovp:event:video-renamed:1-0-0', VideoRenamedV1,
      [],
      [
...
MessageResolver.register('bachelornation:ovp:event:video-renamed', VideoRenamedV1);
