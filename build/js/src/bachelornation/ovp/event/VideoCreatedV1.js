...
export default class VideoCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:ovp:event:video-created:1-0-0', VideoCreatedV1,
      [],
      [
...
MessageResolver.register('bachelornation:ovp:event:video-created', VideoCreatedV1);
