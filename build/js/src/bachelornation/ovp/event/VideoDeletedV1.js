...
export default class VideoDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:ovp:event:video-deleted:1-0-0', VideoDeletedV1,
      [],
      [
...
MessageResolver.register('bachelornation:ovp:event:video-deleted', VideoDeletedV1);
