...
export default class VideoExpiredV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:ovp:event:video-expired:1-0-0', VideoExpiredV1,
      [],
      [
...
MessageResolver.register('bachelornation:ovp:event:video-expired', VideoExpiredV1);
