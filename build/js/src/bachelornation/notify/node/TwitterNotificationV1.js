// @link https://schemas.bachelornation.com/json-schema/bachelornation/notify/node/twitter-notification/1-0-0.json#
...
export default class TwitterNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:notify:node:twitter-notification:1-0-0', TwitterNotificationV1,
      [],
      [
...
MessageResolver.register('bachelornation:notify:node:twitter-notification', TwitterNotificationV1);
