// @link https://schemas.bachelornation.com/json-schema/bachelornation/notify/node/alexa-notification/1-0-0.json#
...
export default class AlexaNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:notify:node:alexa-notification:1-0-0', AlexaNotificationV1,
      [],
      [
...
MessageResolver.register('bachelornation:notify:node:alexa-notification', AlexaNotificationV1);
