// @link https://schemas.bachelornation.com/json-schema/bachelornation/notify/node/email-notification/1-0-0.json#
...
export default class EmailNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:notify:node:email-notification:1-0-0', EmailNotificationV1,
      [],
      [
...
MessageResolver.register('bachelornation:notify:node:email-notification', EmailNotificationV1);
