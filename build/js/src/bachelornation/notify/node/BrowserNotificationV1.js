// @link https://schemas.bachelornation.com/json-schema/bachelornation/notify/node/browser-notification/1-0-0.json#
...
export default class BrowserNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:notify:node:browser-notification:1-0-0', BrowserNotificationV1,
      [],
      [
...
MessageResolver.register('bachelornation:notify:node:browser-notification', BrowserNotificationV1);
