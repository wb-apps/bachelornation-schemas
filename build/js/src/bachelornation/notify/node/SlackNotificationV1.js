// @link https://schemas.bachelornation.com/json-schema/bachelornation/notify/node/slack-notification/1-0-0.json#
...
export default class SlackNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:notify:node:slack-notification:1-0-0', SlackNotificationV1,
      [],
      [
...
MessageResolver.register('bachelornation:notify:node:slack-notification', SlackNotificationV1);
