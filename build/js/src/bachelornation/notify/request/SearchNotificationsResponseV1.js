...
export default class SearchNotificationsResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:notify:request:search-notifications-response:1-0-0', SearchNotificationsResponseV1,
      [],
      [
...
MessageResolver.register('bachelornation:notify:request:search-notifications-response', SearchNotificationsResponseV1);
