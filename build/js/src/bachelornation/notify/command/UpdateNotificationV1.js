...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:bachelornation:notify:command:update-notification:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'bachelornation:notify:command:update-notification';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'bachelornation:notify:command:update-notification:v1';
