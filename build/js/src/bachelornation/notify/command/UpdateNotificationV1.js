...
export default class UpdateNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:bachelornation:notify:command:update-notification:1-0-0', UpdateNotificationV1,
      [],
      [
...
MessageResolver.register('bachelornation:notify:command:update-notification', UpdateNotificationV1);
