...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:iframe-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:iframe-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:iframe-block:v1';
    const MIXINS = [
