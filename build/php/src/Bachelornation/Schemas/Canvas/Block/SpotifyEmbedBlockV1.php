...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:spotify-embed-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:spotify-embed-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:spotify-embed-block:v1';
    const MIXINS = [
