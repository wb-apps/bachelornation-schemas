...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:youtube-video-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:youtube-video-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:youtube-video-block:v1';
    const MIXINS = [
