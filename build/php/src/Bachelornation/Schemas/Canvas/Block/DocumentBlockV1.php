...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:document-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:document-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:document-block:v1';
    const MIXINS = [
