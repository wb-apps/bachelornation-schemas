...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:image-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:image-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:image-block:v1';
    const MIXINS = [
