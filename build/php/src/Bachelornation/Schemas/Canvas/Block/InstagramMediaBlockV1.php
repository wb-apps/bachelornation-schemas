...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:instagram-media-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:instagram-media-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:instagram-media-block:v1';
    const MIXINS = [
