...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:article-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:article-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:article-block:v1';
    const MIXINS = [
