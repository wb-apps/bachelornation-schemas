...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:tumblr-post-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:tumblr-post-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:tumblr-post-block:v1';
    const MIXINS = [
