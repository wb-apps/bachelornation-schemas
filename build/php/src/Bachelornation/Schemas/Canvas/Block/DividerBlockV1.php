...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:divider-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:divider-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:divider-block:v1';
    const MIXINS = [
