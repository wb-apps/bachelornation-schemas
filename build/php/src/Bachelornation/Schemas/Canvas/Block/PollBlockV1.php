...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:poll-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:poll-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:poll-block:v1';
    const MIXINS = [
