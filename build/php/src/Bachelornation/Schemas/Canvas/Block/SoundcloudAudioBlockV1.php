...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:soundcloud-audio-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:soundcloud-audio-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:soundcloud-audio-block:v1';
    const MIXINS = [
