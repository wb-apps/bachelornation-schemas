...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:vimeo-video-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:vimeo-video-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:vimeo-video-block:v1';
    const MIXINS = [
