...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:poll-grid-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:poll-grid-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:poll-grid-block:v1';
    const MIXINS = [
