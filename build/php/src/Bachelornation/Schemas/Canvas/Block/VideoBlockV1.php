...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:video-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:video-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:video-block:v1';
    const MIXINS = [
