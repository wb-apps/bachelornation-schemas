...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:facebook-video-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:facebook-video-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:facebook-video-block:v1';
    const MIXINS = [
