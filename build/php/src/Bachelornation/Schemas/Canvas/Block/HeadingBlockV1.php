...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:heading-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:heading-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:heading-block:v1';
    const MIXINS = [
