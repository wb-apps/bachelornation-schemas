...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:gallery-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:gallery-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:gallery-block:v1';
    const MIXINS = [
