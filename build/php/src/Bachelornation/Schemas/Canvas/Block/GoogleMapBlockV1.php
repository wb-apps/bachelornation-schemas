...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:google-map-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:google-map-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:google-map-block:v1';
    const MIXINS = [
