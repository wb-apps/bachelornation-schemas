...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:quote-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:quote-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:quote-block:v1';
    const MIXINS = [
