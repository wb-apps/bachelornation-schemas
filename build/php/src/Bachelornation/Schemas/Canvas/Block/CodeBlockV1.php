...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:block:code-block:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:block:code-block';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:block:code-block:v1';
    const MIXINS = [
