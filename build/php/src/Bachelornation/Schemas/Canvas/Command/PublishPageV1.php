...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:command:publish-page:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:command:publish-page';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:command:publish-page:v1';
    const MIXINS = [
