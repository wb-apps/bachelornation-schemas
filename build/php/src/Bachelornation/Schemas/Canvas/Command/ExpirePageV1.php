...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:command:expire-page:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:command:expire-page';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:command:expire-page:v1';
    const MIXINS = [
