...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:command:rename-page:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:command:rename-page';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:command:rename-page:v1';
    const MIXINS = [
