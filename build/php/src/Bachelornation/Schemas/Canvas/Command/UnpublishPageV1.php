...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:command:unpublish-page:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:command:unpublish-page';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:command:unpublish-page:v1';
    const MIXINS = [
