...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:command:delete-page:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:command:delete-page';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:command:delete-page:v1';
    const MIXINS = [
