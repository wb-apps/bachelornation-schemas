...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:command:create-page:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:command:create-page';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:command:create-page:v1';
    const MIXINS = [
