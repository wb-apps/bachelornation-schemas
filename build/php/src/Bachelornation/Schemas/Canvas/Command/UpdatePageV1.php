...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:command:update-page:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:command:update-page';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:command:update-page:v1';
    const MIXINS = [
