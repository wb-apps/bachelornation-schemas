...
namespace Bachelornation\Schemas\Canvas\Request;
...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:request:get-page-history-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:request:get-page-history-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:request:get-page-history-response:v1';
    const MIXINS = [
