...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:request:get-page-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:request:get-page-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:request:get-page-request:v1';
    const MIXINS = [
