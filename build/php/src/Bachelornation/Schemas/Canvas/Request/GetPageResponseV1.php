...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:request:get-page-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:request:get-page-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:request:get-page-response:v1';
    const MIXINS = [
