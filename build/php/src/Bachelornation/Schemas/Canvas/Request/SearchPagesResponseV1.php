...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:request:search-pages-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:request:search-pages-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:request:search-pages-response:v1';
    const MIXINS = [
