...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:request:search-pages-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:request:search-pages-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:request:search-pages-request:v1';
    const MIXINS = [
