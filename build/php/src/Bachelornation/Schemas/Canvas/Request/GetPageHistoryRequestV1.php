...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:request:get-page-history-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:request:get-page-history-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:request:get-page-history-request:v1';
    const MIXINS = [
