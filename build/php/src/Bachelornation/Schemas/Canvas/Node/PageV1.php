...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:node:page:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:node:page';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:node:page:v1';
    const MIXINS = [
