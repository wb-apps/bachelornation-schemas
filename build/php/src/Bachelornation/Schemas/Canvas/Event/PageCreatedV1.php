...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:event:page-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:event:page-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:event:page-created:v1';
    const MIXINS = [
