...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:event:page-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:event:page-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:event:page-deleted:v1';
    const MIXINS = [
