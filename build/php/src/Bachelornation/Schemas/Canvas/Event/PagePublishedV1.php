...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:event:page-published:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:event:page-published';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:event:page-published:v1';
    const MIXINS = [
