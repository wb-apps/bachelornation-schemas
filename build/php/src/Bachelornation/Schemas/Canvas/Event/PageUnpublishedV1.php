...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:event:page-unpublished:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:event:page-unpublished';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:event:page-unpublished:v1';
    const MIXINS = [
