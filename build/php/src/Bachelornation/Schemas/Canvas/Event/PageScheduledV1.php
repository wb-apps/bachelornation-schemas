...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:event:page-scheduled:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:event:page-scheduled';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:event:page-scheduled:v1';
    const MIXINS = [
