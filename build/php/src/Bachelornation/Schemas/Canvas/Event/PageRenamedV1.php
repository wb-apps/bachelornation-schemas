...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:event:page-renamed:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:event:page-renamed';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:event:page-renamed:v1';
    const MIXINS = [
