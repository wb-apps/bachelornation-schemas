...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:event:page-expired:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:event:page-expired';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:event:page-expired:v1';
    const MIXINS = [
