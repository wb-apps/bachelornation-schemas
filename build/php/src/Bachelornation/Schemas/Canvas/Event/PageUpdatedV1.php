...
{
    const SCHEMA_ID = 'pbj:bachelornation:canvas:event:page-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:canvas:event:page-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:canvas:event:page-updated:v1';
    const MIXINS = [
