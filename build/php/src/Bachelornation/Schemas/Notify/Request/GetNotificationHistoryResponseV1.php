...
namespace Bachelornation\Schemas\Notify\Request;
...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:request:get-notification-history-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:request:get-notification-history-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:request:get-notification-history-response:v1';
    const MIXINS = [
