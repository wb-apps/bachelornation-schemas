...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:request:search-notifications-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:request:search-notifications-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:request:search-notifications-request:v1';
    const MIXINS = [
