...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:request:get-notification-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:request:get-notification-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:request:get-notification-request:v1';
    const MIXINS = [
