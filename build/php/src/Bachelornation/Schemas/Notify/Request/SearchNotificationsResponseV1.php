...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:request:search-notifications-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:request:search-notifications-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:request:search-notifications-response:v1';
    const MIXINS = [
