...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:event:notification-sent:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:event:notification-sent';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:event:notification-sent:v1';
    const MIXINS = [
