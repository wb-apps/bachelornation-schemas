...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:event:notification-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:event:notification-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:event:notification-created:v1';
    const MIXINS = [
