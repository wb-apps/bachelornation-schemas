...
namespace Bachelornation\Schemas\Notify\Event;
...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:event:notification-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:event:notification-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:event:notification-updated:v1';
    const MIXINS = [
