...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:event:notification-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:event:notification-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:event:notification-deleted:v1';
    const MIXINS = [
