...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:event:notification-failed:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:event:notification-failed';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:event:notification-failed:v1';
    const MIXINS = [
