...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:command:send-notification:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:command:send-notification';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:command:send-notification:v1';
    const MIXINS = [
