...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:command:update-notification:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:command:update-notification';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:command:update-notification:v1';
    const MIXINS = [
