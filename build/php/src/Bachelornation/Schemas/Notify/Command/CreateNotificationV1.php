...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:command:create-notification:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:command:create-notification';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:command:create-notification:v1';
    const MIXINS = [
