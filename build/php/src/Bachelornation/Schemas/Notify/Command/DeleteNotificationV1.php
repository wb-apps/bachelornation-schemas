...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:command:delete-notification:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:command:delete-notification';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:command:delete-notification:v1';
    const MIXINS = [
