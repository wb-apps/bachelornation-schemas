...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:node:android-notification:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:node:android-notification';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:node:android-notification:v1';
    const MIXINS = [
