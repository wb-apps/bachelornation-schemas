...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:node:email-notification:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:node:email-notification';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:node:email-notification:v1';
    const MIXINS = [
