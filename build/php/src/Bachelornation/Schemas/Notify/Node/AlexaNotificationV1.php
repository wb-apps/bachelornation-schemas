...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:node:alexa-notification:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:node:alexa-notification';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:node:alexa-notification:v1';
    const MIXINS = [
