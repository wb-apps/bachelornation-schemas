...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:node:browser-notification:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:node:browser-notification';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:node:browser-notification:v1';
    const MIXINS = [
