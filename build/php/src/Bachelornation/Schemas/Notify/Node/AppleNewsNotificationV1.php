...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:node:apple-news-notification:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:node:apple-news-notification';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:node:apple-news-notification:v1';
    const MIXINS = [
