...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:node:sms-notification:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:node:sms-notification';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:node:sms-notification:v1';
    const MIXINS = [
