...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:node:slack-notification:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:node:slack-notification';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:node:slack-notification:v1';
    const MIXINS = [
