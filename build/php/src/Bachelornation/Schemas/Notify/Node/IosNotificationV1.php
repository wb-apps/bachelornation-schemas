...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:node:ios-notification:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:node:ios-notification';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:node:ios-notification:v1';
    const MIXINS = [
