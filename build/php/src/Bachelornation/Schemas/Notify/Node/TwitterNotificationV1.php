...
{
    const SCHEMA_ID = 'pbj:bachelornation:notify:node:twitter-notification:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:notify:node:twitter-notification';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:notify:node:twitter-notification:v1';
    const MIXINS = [
