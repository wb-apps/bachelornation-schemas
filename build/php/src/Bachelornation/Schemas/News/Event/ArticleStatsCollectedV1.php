...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:event:article-stats-collected:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:event:article-stats-collected';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:event:article-stats-collected:v1';
    const MIXINS = [
