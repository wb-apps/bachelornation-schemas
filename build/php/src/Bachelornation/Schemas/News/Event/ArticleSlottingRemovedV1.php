...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:event:article-slotting-removed:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:event:article-slotting-removed';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:event:article-slotting-removed:v1';
    const MIXINS = [
