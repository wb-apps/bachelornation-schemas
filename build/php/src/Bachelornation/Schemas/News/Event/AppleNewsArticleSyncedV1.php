...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:event:apple-news-article-synced:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:event:apple-news-article-synced';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:event:apple-news-article-synced:v1';
    const MIXINS = [
