...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:event:article-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:event:article-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:event:article-deleted:v1';
    const MIXINS = [
