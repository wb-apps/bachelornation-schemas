...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:event:article-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:event:article-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:event:article-created:v1';
    const MIXINS = [
