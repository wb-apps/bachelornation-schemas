...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:event:article-expired:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:event:article-expired';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:event:article-expired:v1';
    const MIXINS = [
