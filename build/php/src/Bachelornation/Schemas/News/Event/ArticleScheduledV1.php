...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:event:article-scheduled:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:event:article-scheduled';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:event:article-scheduled:v1';
    const MIXINS = [
