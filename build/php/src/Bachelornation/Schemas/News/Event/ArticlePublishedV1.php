...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:event:article-published:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:event:article-published';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:event:article-published:v1';
    const MIXINS = [
