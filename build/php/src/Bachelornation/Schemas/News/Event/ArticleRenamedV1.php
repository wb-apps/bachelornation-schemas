...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:event:article-renamed:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:event:article-renamed';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:event:article-renamed:v1';
    const MIXINS = [
