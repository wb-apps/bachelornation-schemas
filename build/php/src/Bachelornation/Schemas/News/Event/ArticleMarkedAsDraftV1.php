...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:event:article-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:event:article-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:event:article-marked-as-draft:v1';
    const MIXINS = [
