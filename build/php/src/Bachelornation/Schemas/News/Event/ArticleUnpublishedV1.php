...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:event:article-unpublished:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:event:article-unpublished';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:event:article-unpublished:v1';
    const MIXINS = [
