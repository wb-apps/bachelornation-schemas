...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:event:article-locked:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:event:article-locked';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:event:article-locked:v1';
    const MIXINS = [
