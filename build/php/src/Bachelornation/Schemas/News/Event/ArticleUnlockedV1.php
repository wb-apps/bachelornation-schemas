...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:event:article-unlocked:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:event:article-unlocked';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:event:article-unlocked:v1';
    const MIXINS = [
