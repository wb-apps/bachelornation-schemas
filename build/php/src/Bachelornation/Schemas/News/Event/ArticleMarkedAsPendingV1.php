...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:event:article-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:event:article-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:event:article-marked-as-pending:v1';
    const MIXINS = [
