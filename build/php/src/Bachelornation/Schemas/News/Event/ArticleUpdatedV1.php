...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:event:article-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:event:article-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:event:article-updated:v1';
    const MIXINS = [
