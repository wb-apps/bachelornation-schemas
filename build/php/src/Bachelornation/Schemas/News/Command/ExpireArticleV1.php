...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:command:expire-article:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:command:expire-article';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:command:expire-article:v1';
    const MIXINS = [
