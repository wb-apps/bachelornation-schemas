...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:command:mark-article-as-draft:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:command:mark-article-as-draft';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:command:mark-article-as-draft:v1';
    const MIXINS = [
