...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:command:remove-article-slotting:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:command:remove-article-slotting';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:command:remove-article-slotting:v1';
    const MIXINS = [
