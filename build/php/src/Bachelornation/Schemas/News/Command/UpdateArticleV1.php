...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:command:update-article:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:command:update-article';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:command:update-article:v1';
    const MIXINS = [
