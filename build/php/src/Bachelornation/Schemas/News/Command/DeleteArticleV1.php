...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:command:delete-article:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:command:delete-article';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:command:delete-article:v1';
    const MIXINS = [
