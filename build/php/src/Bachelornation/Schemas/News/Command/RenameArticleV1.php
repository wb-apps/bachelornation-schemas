...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:command:rename-article:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:command:rename-article';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:command:rename-article:v1';
    const MIXINS = [
