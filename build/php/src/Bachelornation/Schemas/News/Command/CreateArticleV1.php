...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:command:create-article:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:command:create-article';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:command:create-article:v1';
    const MIXINS = [
