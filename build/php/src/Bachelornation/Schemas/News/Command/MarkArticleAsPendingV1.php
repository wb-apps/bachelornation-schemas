...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:command:mark-article-as-pending:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:command:mark-article-as-pending';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:command:mark-article-as-pending:v1';
    const MIXINS = [
