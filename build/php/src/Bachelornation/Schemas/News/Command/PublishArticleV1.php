...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:command:publish-article:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:command:publish-article';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:command:publish-article:v1';
    const MIXINS = [
