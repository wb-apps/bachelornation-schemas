...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:command:lock-article:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:command:lock-article';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:command:lock-article:v1';
    const MIXINS = [
