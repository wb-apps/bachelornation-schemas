...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:command:unlock-article:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:command:unlock-article';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:command:unlock-article:v1';
    const MIXINS = [
