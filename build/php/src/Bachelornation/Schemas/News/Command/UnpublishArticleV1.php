...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:command:unpublish-article:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:command:unpublish-article';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:command:unpublish-article:v1';
    const MIXINS = [
