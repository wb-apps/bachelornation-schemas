...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:command:collect-article-stats:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:command:collect-article-stats';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:command:collect-article-stats:v1';
    const MIXINS = [
