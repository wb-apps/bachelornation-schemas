...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:node:article-stats:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:node:article-stats';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:node:article-stats:v1';
    const MIXINS = [
