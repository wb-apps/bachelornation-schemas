...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:node:article:1-0-1';
    const SCHEMA_CURIE = 'bachelornation:news:node:article';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:node:article:v1';
    const MIXINS = [
