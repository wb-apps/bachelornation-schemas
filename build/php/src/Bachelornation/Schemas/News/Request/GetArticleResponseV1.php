...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:request:get-article-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:request:get-article-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:request:get-article-response:v1';
    const MIXINS = [
