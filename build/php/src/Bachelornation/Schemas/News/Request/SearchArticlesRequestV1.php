...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:request:search-articles-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:request:search-articles-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:request:search-articles-request:v1';
    const MIXINS = [
