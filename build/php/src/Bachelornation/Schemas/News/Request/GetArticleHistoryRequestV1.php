...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:request:get-article-history-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:request:get-article-history-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:request:get-article-history-request:v1';
    const MIXINS = [
