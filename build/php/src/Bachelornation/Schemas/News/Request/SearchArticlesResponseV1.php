...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:request:search-articles-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:request:search-articles-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:request:search-articles-response:v1';
    const MIXINS = [
