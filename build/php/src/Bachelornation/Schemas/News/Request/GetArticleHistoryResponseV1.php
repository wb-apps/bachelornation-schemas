...
{
    const SCHEMA_ID = 'pbj:bachelornation:news:request:get-article-history-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:news:request:get-article-history-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:news:request:get-article-history-response:v1';
    const MIXINS = [
