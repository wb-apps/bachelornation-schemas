...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:command:rename-channel:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:command:rename-channel';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:command:rename-channel:v1';
    const MIXINS = [
