...
namespace Bachelornation\Schemas\Taxonomy\Command;
...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:command:delete-category:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:command:delete-category';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:command:delete-category:v1';
    const MIXINS = [
