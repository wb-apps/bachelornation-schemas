...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:command:update-channel:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:command:update-channel';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:command:update-channel:v1';
    const MIXINS = [
