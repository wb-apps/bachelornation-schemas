...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:command:create-channel:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:command:create-channel';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:command:create-channel:v1';
    const MIXINS = [
