...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:command:create-category:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:command:create-category';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:command:create-category:v1';
    const MIXINS = [
