...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:command:rename-category:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:command:rename-category';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:command:rename-category:v1';
    const MIXINS = [
