...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:command:delete-channel:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:command:delete-channel';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:command:delete-channel:v1';
    const MIXINS = [
