...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:command:update-category:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:command:update-category';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:command:update-category:v1';
    const MIXINS = [
