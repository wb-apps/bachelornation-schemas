...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:node:category:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:node:category';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:node:category:v1';
    const MIXINS = [
