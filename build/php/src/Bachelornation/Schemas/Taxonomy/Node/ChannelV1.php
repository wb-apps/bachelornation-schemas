...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:node:channel:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:node:channel';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:node:channel:v1';
    const MIXINS = [
