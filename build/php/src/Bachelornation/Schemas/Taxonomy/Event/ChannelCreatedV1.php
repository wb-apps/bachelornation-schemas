...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:event:channel-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:event:channel-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:event:channel-created:v1';
    const MIXINS = [
