...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:event:category-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:event:category-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:event:category-created:v1';
    const MIXINS = [
