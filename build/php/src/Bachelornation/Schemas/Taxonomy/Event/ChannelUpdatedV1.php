...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:event:channel-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:event:channel-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:event:channel-updated:v1';
    const MIXINS = [
