...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:event:category-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:event:category-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:event:category-deleted:v1';
    const MIXINS = [
