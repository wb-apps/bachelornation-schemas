...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:event:category-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:event:category-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:event:category-updated:v1';
    const MIXINS = [
