...
namespace Bachelornation\Schemas\Taxonomy\Event;
...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:event:category-renamed:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:event:category-renamed';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:event:category-renamed:v1';
    const MIXINS = [
