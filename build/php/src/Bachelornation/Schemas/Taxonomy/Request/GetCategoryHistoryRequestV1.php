...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:request:get-category-history-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:request:get-category-history-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:request:get-category-history-request:v1';
    const MIXINS = [
