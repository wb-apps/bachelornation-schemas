...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:request:get-all-channels-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:request:get-all-channels-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:request:get-all-channels-request:v1';
    const MIXINS = [
