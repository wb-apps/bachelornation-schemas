...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:request:get-category-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:request:get-category-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:request:get-category-response:v1';
    const MIXINS = [
