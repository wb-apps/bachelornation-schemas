...
{
    const SCHEMA_ID = 'pbj:bachelornation:taxonomy:request:get-channel-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:taxonomy:request:get-channel-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:taxonomy:request:get-channel-response:v1';
    const MIXINS = [
