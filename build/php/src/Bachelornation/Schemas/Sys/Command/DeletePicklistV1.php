...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:command:delete-picklist:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:command:delete-picklist';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:command:delete-picklist:v1';
    const MIXINS = [
