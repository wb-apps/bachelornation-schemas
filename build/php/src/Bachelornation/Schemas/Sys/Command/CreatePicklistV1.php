...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:command:create-picklist:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:command:create-picklist';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:command:create-picklist:v1';
    const MIXINS = [
