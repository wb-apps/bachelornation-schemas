...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:command:create-flagset:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:command:create-flagset';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:command:create-flagset:v1';
    const MIXINS = [
