...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:command:create-redirect:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:command:create-redirect';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:command:create-redirect:v1';
    const MIXINS = [
