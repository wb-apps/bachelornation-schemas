...
namespace Bachelornation\Schemas\Sys\Command;
...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:command:delete-redirect:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:command:delete-redirect';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:command:delete-redirect:v1';
    const MIXINS = [
