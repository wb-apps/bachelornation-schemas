...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:command:update-flagset:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:command:update-flagset';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:command:update-flagset:v1';
    const MIXINS = [
