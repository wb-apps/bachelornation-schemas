...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:command:update-redirect:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:command:update-redirect';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:command:update-redirect:v1';
    const MIXINS = [
