...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:command:update-picklist:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:command:update-picklist';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:command:update-picklist:v1';
    const MIXINS = [
