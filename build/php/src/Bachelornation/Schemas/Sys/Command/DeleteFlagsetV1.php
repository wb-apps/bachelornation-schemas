...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:command:delete-flagset:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:command:delete-flagset';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:command:delete-flagset:v1';
    const MIXINS = [
