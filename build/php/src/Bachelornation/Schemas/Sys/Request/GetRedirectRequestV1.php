...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:request:get-redirect-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:request:get-redirect-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:request:get-redirect-request:v1';
    const MIXINS = [
