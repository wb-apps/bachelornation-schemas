...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:request:search-redirects-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:request:search-redirects-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:request:search-redirects-request:v1';
    const MIXINS = [
