...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:request:get-flagset-history-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:request:get-flagset-history-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:request:get-flagset-history-response:v1';
    const MIXINS = [
