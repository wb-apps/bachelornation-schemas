...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:request:get-redirect-history-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:request:get-redirect-history-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:request:get-redirect-history-request:v1';
    const MIXINS = [
