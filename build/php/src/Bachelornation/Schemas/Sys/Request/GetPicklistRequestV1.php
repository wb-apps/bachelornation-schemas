...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:request:get-picklist-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:request:get-picklist-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:request:get-picklist-request:v1';
    const MIXINS = [
