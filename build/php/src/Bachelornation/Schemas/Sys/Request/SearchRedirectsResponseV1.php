...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:request:search-redirects-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:request:search-redirects-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:request:search-redirects-response:v1';
    const MIXINS = [
