...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:event:flagset-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:event:flagset-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:event:flagset-updated:v1';
    const MIXINS = [
