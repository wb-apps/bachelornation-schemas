...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:event:picklist-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:event:picklist-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:event:picklist-created:v1';
    const MIXINS = [
