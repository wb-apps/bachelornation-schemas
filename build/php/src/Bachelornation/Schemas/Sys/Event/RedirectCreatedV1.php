...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:event:redirect-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:event:redirect-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:event:redirect-created:v1';
    const MIXINS = [
