...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:event:flagset-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:event:flagset-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:event:flagset-deleted:v1';
    const MIXINS = [
