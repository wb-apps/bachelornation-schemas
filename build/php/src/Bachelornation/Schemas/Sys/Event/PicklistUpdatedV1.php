...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:event:picklist-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:event:picklist-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:event:picklist-updated:v1';
    const MIXINS = [
