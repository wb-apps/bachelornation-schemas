...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:event:flagset-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:event:flagset-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:event:flagset-created:v1';
    const MIXINS = [
