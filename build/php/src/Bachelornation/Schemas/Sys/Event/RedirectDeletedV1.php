...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:event:redirect-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:event:redirect-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:event:redirect-deleted:v1';
    const MIXINS = [
