...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:event:picklist-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:event:picklist-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:event:picklist-deleted:v1';
    const MIXINS = [
