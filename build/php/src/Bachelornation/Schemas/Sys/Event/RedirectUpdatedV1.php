...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:event:redirect-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:event:redirect-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:event:redirect-updated:v1';
    const MIXINS = [
