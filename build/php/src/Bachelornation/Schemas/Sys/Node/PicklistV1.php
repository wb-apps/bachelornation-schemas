...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:node:picklist:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:node:picklist';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:node:picklist:v1';
    const MIXINS = [
