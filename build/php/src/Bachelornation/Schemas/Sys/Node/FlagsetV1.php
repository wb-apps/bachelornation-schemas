...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:node:flagset:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:node:flagset';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:node:flagset:v1';
    const MIXINS = [
