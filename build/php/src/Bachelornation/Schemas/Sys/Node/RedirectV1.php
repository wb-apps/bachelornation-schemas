...
namespace Bachelornation\Schemas\Sys\Node;
...
{
    const SCHEMA_ID = 'pbj:bachelornation:sys:node:redirect:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:sys:node:redirect';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:sys:node:redirect:v1';
    const MIXINS = [
