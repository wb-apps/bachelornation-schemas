...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:node:poll-stats:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:node:poll-stats';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:node:poll-stats:v1';
    const MIXINS = [
