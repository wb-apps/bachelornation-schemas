...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:node:poll:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:node:poll';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:node:poll:v1';
    const MIXINS = [
