...
namespace Bachelornation\Schemas\Apollo\Event;
...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:event:poll-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:event:poll-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:event:poll-marked-as-pending:v1';
    const MIXINS = [
