...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:event:vote-casted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:event:vote-casted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:event:vote-casted:v1';
    const MIXINS = [
