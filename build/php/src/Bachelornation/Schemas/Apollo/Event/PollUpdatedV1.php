...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:event:poll-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:event:poll-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:event:poll-updated:v1';
    const MIXINS = [
