...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:event:poll-scheduled:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:event:poll-scheduled';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:event:poll-scheduled:v1';
    const MIXINS = [
