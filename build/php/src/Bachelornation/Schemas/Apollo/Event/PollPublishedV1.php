...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:event:poll-published:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:event:poll-published';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:event:poll-published:v1';
    const MIXINS = [
