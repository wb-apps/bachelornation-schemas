...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:event:poll-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:event:poll-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:event:poll-created:v1';
    const MIXINS = [
