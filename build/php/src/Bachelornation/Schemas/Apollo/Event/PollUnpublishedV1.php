...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:event:poll-unpublished:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:event:poll-unpublished';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:event:poll-unpublished:v1';
    const MIXINS = [
