...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:event:poll-expired:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:event:poll-expired';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:event:poll-expired:v1';
    const MIXINS = [
