...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:event:poll-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:event:poll-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:event:poll-deleted:v1';
    const MIXINS = [
