...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo::poll-answer:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo::poll-answer';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo::poll-answer:v1';
    const MIXINS = [
