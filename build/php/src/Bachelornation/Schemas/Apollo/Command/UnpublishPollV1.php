...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:command:unpublish-poll:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:command:unpublish-poll';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:command:unpublish-poll:v1';
    const MIXINS = [
