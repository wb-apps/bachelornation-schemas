...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:command:cast-vote:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:command:cast-vote';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:command:cast-vote:v1';
    const MIXINS = [
