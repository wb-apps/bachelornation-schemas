...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:command:delete-poll:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:command:delete-poll';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:command:delete-poll:v1';
    const MIXINS = [
