...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:command:publish-poll:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:command:publish-poll';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:command:publish-poll:v1';
    const MIXINS = [
