...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:command:update-poll:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:command:update-poll';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:command:update-poll:v1';
    const MIXINS = [
