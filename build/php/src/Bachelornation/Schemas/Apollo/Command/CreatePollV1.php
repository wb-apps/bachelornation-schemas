...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:command:create-poll:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:command:create-poll';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:command:create-poll:v1';
    const MIXINS = [
