...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:command:expire-poll:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:command:expire-poll';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:command:expire-poll:v1';
    const MIXINS = [
