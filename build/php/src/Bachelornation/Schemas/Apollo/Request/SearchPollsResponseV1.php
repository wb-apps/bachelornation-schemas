...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:request:search-polls-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:request:search-polls-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:request:search-polls-response:v1';
    const MIXINS = [
