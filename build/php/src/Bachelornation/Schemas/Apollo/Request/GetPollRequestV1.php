...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:request:get-poll-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:request:get-poll-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:request:get-poll-request:v1';
    const MIXINS = [
