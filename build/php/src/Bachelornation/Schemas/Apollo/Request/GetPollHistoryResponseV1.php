...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:request:get-poll-history-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:request:get-poll-history-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:request:get-poll-history-response:v1';
    const MIXINS = [
