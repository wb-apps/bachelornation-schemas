...
{
    const SCHEMA_ID = 'pbj:bachelornation:apollo:request:search-polls-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:apollo:request:search-polls-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:apollo:request:search-polls-request:v1';
    const MIXINS = [
