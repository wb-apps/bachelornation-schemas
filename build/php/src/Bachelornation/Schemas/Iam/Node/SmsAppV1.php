...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:node:sms-app:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:node:sms-app';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:node:sms-app:v1';
    const MIXINS = [
