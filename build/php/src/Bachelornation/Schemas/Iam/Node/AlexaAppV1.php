...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:node:alexa-app:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:node:alexa-app';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:node:alexa-app:v1';
    const MIXINS = [
