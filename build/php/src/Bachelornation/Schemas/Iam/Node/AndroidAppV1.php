...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:node:android-app:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:node:android-app';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:node:android-app:v1';
    const MIXINS = [
