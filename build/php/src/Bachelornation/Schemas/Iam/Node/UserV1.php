...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:node:user:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:node:user';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:node:user:v1';
    const MIXINS = [
