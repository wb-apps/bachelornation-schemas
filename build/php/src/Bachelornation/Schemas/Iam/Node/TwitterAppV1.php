...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:node:twitter-app:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:node:twitter-app';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:node:twitter-app:v1';
    const MIXINS = [
