...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:node:apple-news-app:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:node:apple-news-app';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:node:apple-news-app:v1';
    const MIXINS = [
