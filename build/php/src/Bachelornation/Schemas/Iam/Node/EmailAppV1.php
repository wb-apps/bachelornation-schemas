...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:node:email-app:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:node:email-app';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:node:email-app:v1';
    const MIXINS = [
