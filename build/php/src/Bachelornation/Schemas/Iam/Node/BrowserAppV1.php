...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:node:browser-app:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:node:browser-app';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:node:browser-app:v1';
    const MIXINS = [
