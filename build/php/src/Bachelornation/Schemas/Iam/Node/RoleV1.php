...
namespace Bachelornation\Schemas\Iam\Node;
...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:node:role:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:node:role';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:node:role:v1';
    const MIXINS = [
