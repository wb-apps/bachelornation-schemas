...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:node:ios-app:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:node:ios-app';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:node:ios-app:v1';
    const MIXINS = [
