...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:node:slack-app:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:node:slack-app';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:node:slack-app:v1';
    const MIXINS = [
