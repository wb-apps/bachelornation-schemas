...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:request:search-users-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:request:search-users-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:request:search-users-request:v1';
    const MIXINS = [
