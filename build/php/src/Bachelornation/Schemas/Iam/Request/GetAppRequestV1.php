...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:request:get-app-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:request:get-app-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:request:get-app-request:v1';
    const MIXINS = [
