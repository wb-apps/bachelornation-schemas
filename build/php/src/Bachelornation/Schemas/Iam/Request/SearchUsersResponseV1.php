...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:request:search-users-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:request:search-users-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:request:search-users-response:v1';
    const MIXINS = [
