...
namespace Bachelornation\Schemas\Iam\Request;
...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:request:get-user-history-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:request:get-user-history-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:request:get-user-history-response:v1';
    const MIXINS = [
