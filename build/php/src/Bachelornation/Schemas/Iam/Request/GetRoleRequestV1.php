...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:request:get-role-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:request:get-role-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:request:get-role-request:v1';
    const MIXINS = [
