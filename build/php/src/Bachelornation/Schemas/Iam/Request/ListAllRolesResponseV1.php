...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:request:list-all-roles-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:request:list-all-roles-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:request:list-all-roles-response:v1';
    const MIXINS = [
