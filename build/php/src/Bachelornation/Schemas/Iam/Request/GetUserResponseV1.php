...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:request:get-user-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:request:get-user-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:request:get-user-response:v1';
    const MIXINS = [
