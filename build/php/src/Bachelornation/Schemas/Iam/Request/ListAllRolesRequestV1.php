...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:request:list-all-roles-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:request:list-all-roles-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:request:list-all-roles-request:v1';
    const MIXINS = [
