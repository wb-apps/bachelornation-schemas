...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:request:get-all-apps-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:request:get-all-apps-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:request:get-all-apps-response:v1';
    const MIXINS = [
