...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:request:get-app-history-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:request:get-app-history-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:request:get-app-history-response:v1';
    const MIXINS = [
