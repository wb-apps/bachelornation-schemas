...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:request:get-role-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:request:get-role-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:request:get-role-response:v1';
    const MIXINS = [
