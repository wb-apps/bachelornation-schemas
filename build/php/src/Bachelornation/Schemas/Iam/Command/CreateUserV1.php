...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:command:create-user:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:command:create-user';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:command:create-user:v1';
    const MIXINS = [
