...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:command:update-user:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:command:update-user';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:command:update-user:v1';
    const MIXINS = [
