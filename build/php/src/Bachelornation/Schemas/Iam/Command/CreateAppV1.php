...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:command:create-app:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:command:create-app';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:command:create-app:v1';
    const MIXINS = [
