...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:command:create-role:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:command:create-role';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:command:create-role:v1';
    const MIXINS = [
