...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:command:delete-app:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:command:delete-app';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:command:delete-app:v1';
    const MIXINS = [
