...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:command:update-app:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:command:update-app';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:command:update-app:v1';
    const MIXINS = [
