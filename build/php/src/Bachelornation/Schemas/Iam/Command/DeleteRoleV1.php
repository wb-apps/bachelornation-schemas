...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:command:delete-role:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:command:delete-role';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:command:delete-role:v1';
    const MIXINS = [
