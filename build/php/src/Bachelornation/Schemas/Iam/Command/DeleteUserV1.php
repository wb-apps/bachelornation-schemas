...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:command:delete-user:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:command:delete-user';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:command:delete-user:v1';
    const MIXINS = [
