...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:command:update-role:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:command:update-role';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:command:update-role:v1';
    const MIXINS = [
