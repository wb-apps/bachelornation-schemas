...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:event:app-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:event:app-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:event:app-deleted:v1';
    const MIXINS = [
