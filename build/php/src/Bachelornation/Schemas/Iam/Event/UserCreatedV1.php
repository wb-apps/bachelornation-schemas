...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:event:user-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:event:user-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:event:user-created:v1';
    const MIXINS = [
