...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:event:app-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:event:app-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:event:app-created:v1';
    const MIXINS = [
