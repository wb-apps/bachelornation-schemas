...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:event:role-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:event:role-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:event:role-deleted:v1';
    const MIXINS = [
