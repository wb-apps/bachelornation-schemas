...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:event:user-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:event:user-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:event:user-updated:v1';
    const MIXINS = [
