...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:event:user-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:event:user-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:event:user-deleted:v1';
    const MIXINS = [
