...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:event:user-roles-granted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:event:user-roles-granted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:event:user-roles-granted:v1';
    const MIXINS = [
