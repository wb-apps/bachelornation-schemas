...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:event:role-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:event:role-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:event:role-created:v1';
    const MIXINS = [
