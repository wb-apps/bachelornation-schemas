...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:event:role-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:event:role-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:event:role-updated:v1';
    const MIXINS = [
