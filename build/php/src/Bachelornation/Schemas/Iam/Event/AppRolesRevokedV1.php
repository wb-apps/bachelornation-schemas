...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:event:app-roles-revoked:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:event:app-roles-revoked';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:event:app-roles-revoked:v1';
    const MIXINS = [
