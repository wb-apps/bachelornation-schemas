...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:event:app-roles-granted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:event:app-roles-granted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:event:app-roles-granted:v1';
    const MIXINS = [
