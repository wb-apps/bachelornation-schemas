...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:event:app-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:event:app-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:event:app-updated:v1';
    const MIXINS = [
