...
{
    const SCHEMA_ID = 'pbj:bachelornation:iam:event:user-roles-revoked:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:iam:event:user-roles-revoked';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:iam:event:user-roles-revoked:v1';
    const MIXINS = [
