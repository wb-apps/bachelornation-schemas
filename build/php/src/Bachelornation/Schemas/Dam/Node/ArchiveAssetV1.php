...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:node:archive-asset:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:node:archive-asset';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:node:archive-asset:v1';
    const MIXINS = [
