...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:node:code-asset:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:node:code-asset';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:node:code-asset:v1';
    const MIXINS = [
