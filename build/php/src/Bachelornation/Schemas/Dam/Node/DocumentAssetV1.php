...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:node:document-asset:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:node:document-asset';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:node:document-asset:v1';
    const MIXINS = [
