...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:node:audio-asset:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:node:audio-asset';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:node:audio-asset:v1';
    const MIXINS = [
