...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:node:video-asset:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:node:video-asset';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:node:video-asset:v1';
    const MIXINS = [
