...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:node:image-asset:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:node:image-asset';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:node:image-asset:v1';
    const MIXINS = [
