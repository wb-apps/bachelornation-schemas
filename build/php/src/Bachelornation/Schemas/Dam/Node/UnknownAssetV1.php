...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:node:unknown-asset:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:node:unknown-asset';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:node:unknown-asset:v1';
    const MIXINS = [
