...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:command:patch-assets:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:command:patch-assets';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:command:patch-assets:v1';
    const MIXINS = [
