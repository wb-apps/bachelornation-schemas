...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:command:update-asset:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:command:update-asset';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:command:update-asset:v1';
    const MIXINS = [
