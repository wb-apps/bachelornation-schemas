...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:command:unlink-assets:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:command:unlink-assets';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:command:unlink-assets:v1';
    const MIXINS = [
