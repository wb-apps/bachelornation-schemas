...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:command:delete-asset:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:command:delete-asset';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:command:delete-asset:v1';
    const MIXINS = [
