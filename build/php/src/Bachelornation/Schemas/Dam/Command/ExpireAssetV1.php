...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:command:expire-asset:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:command:expire-asset';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:command:expire-asset:v1';
    const MIXINS = [
