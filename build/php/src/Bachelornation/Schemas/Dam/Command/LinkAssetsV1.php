...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:command:link-assets:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:command:link-assets';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:command:link-assets:v1';
    const MIXINS = [
