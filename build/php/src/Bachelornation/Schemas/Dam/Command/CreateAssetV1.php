...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:command:create-asset:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:command:create-asset';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:command:create-asset:v1';
    const MIXINS = [
