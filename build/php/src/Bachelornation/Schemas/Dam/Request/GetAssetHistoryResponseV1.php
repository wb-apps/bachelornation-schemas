...
namespace Bachelornation\Schemas\Dam\Request;
...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:request:get-asset-history-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:request:get-asset-history-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:request:get-asset-history-response:v1';
    const MIXINS = [
