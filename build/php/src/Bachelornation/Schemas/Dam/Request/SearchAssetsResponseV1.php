...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:request:search-assets-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:request:search-assets-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:request:search-assets-response:v1';
    const MIXINS = [
