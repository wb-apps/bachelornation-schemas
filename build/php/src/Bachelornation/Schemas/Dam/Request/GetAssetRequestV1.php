...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:request:get-asset-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:request:get-asset-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:request:get-asset-request:v1';
    const MIXINS = [
