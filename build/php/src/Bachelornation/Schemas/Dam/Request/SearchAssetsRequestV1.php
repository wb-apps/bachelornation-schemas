...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:request:search-assets-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:request:search-assets-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:request:search-assets-request:v1';
    const MIXINS = [
