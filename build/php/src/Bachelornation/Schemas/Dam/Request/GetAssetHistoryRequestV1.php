...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:request:get-asset-history-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:request:get-asset-history-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:request:get-asset-history-request:v1';
    const MIXINS = [
