...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:request:get-upload-urls-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:request:get-upload-urls-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:request:get-upload-urls-response:v1';
    const MIXINS = [
