...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:event:asset-linked:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:event:asset-linked';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:event:asset-linked:v1';
    const MIXINS = [
