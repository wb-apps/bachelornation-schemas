...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:event:asset-expired:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:event:asset-expired';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:event:asset-expired:v1';
    const MIXINS = [
