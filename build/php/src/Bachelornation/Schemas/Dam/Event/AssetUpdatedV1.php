...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:event:asset-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:event:asset-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:event:asset-updated:v1';
    const MIXINS = [
