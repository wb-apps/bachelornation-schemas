...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:event:asset-patched:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:event:asset-patched';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:event:asset-patched:v1';
    const MIXINS = [
