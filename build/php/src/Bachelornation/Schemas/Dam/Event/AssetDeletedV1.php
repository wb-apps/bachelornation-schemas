...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:event:asset-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:event:asset-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:event:asset-deleted:v1';
    const MIXINS = [
