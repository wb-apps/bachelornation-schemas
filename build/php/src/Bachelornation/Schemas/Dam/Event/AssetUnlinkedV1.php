...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:event:asset-unlinked:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:event:asset-unlinked';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:event:asset-unlinked:v1';
    const MIXINS = [
