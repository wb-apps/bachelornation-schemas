...
{
    const SCHEMA_ID = 'pbj:bachelornation:dam:event:asset-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:dam:event:asset-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:dam:event:asset-created:v1';
    const MIXINS = [
