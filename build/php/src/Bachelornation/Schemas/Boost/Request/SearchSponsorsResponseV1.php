...
{
    const SCHEMA_ID = 'pbj:bachelornation:boost:request:search-sponsors-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:boost:request:search-sponsors-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:boost:request:search-sponsors-response:v1';
    const MIXINS = [
