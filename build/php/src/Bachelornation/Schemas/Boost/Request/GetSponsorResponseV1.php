...
{
    const SCHEMA_ID = 'pbj:bachelornation:boost:request:get-sponsor-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:boost:request:get-sponsor-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:boost:request:get-sponsor-response:v1';
    const MIXINS = [
