...
{
    const SCHEMA_ID = 'pbj:bachelornation:boost:request:search-sponsors-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:boost:request:search-sponsors-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:boost:request:search-sponsors-request:v1';
    const MIXINS = [
