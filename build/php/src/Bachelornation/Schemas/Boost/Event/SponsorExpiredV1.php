...
{
    const SCHEMA_ID = 'pbj:bachelornation:boost:event:sponsor-expired:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:boost:event:sponsor-expired';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:boost:event:sponsor-expired:v1';
    const MIXINS = [
