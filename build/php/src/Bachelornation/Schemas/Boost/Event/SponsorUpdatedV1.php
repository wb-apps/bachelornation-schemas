...
{
    const SCHEMA_ID = 'pbj:bachelornation:boost:event:sponsor-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:boost:event:sponsor-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:boost:event:sponsor-updated:v1';
    const MIXINS = [
