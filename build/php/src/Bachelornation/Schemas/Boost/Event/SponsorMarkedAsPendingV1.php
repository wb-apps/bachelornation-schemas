...
namespace Bachelornation\Schemas\Boost\Event;
...
{
    const SCHEMA_ID = 'pbj:bachelornation:boost:event:sponsor-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:boost:event:sponsor-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:boost:event:sponsor-marked-as-pending:v1';
    const MIXINS = [
