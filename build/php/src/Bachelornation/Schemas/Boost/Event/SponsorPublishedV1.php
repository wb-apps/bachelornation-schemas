...
{
    const SCHEMA_ID = 'pbj:bachelornation:boost:event:sponsor-published:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:boost:event:sponsor-published';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:boost:event:sponsor-published:v1';
    const MIXINS = [
