...
{
    const SCHEMA_ID = 'pbj:bachelornation:boost:event:sponsor-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:boost:event:sponsor-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:boost:event:sponsor-deleted:v1';
    const MIXINS = [
