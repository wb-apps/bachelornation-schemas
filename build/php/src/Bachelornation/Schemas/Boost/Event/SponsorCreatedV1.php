...
{
    const SCHEMA_ID = 'pbj:bachelornation:boost:event:sponsor-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:boost:event:sponsor-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:boost:event:sponsor-created:v1';
    const MIXINS = [
