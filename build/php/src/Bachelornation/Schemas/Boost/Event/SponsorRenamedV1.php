...
{
    const SCHEMA_ID = 'pbj:bachelornation:boost:event:sponsor-renamed:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:boost:event:sponsor-renamed';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:boost:event:sponsor-renamed:v1';
    const MIXINS = [
