...
{
    const SCHEMA_ID = 'pbj:bachelornation:boost:command:publish-sponsor:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:boost:command:publish-sponsor';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:boost:command:publish-sponsor:v1';
    const MIXINS = [
