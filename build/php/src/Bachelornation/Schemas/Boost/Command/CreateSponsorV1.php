...
{
    const SCHEMA_ID = 'pbj:bachelornation:boost:command:create-sponsor:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:boost:command:create-sponsor';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:boost:command:create-sponsor:v1';
    const MIXINS = [
