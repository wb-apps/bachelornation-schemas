...
{
    const SCHEMA_ID = 'pbj:bachelornation:boost:command:rename-sponsor:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:boost:command:rename-sponsor';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:boost:command:rename-sponsor:v1';
    const MIXINS = [
