...
{
    const SCHEMA_ID = 'pbj:bachelornation:boost:command:expire-sponsor:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:boost:command:expire-sponsor';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:boost:command:expire-sponsor:v1';
    const MIXINS = [
