...
{
    const SCHEMA_ID = 'pbj:bachelornation:boost:command:update-sponsor:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:boost:command:update-sponsor';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:boost:command:update-sponsor:v1';
    const MIXINS = [
