...
{
    const SCHEMA_ID = 'pbj:bachelornation:boost:command:delete-sponsor:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:boost:command:delete-sponsor';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:boost:command:delete-sponsor:v1';
    const MIXINS = [
