...
{
    const SCHEMA_ID = 'pbj:bachelornation:people:request:search-people-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:people:request:search-people-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:people:request:search-people-response:v1';
    const MIXINS = [
