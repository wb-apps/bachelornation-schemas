...
{
    const SCHEMA_ID = 'pbj:bachelornation:people:request:get-person-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:people:request:get-person-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:people:request:get-person-response:v1';
    const MIXINS = [
