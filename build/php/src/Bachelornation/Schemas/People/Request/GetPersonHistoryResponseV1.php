...
{
    const SCHEMA_ID = 'pbj:bachelornation:people:request:get-person-history-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:people:request:get-person-history-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:people:request:get-person-history-response:v1';
    const MIXINS = [
