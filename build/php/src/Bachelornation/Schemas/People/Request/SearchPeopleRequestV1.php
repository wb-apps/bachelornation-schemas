...
{
    const SCHEMA_ID = 'pbj:bachelornation:people:request:search-people-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:people:request:search-people-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:people:request:search-people-request:v1';
    const MIXINS = [
