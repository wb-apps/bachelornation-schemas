...
{
    const SCHEMA_ID = 'pbj:bachelornation:people:request:get-person-history-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:people:request:get-person-history-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:people:request:get-person-history-request:v1';
    const MIXINS = [
