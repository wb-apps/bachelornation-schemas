...
{
    const SCHEMA_ID = 'pbj:bachelornation:people:request:get-person-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:people:request:get-person-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:people:request:get-person-request:v1';
    const MIXINS = [
