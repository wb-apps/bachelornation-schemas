...
{
    const SCHEMA_ID = 'pbj:bachelornation:people:command:delete-person:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:people:command:delete-person';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:people:command:delete-person:v1';
    const MIXINS = [
