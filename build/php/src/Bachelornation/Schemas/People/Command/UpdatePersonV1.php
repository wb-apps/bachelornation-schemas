...
{
    const SCHEMA_ID = 'pbj:bachelornation:people:command:update-person:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:people:command:update-person';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:people:command:update-person:v1';
    const MIXINS = [
