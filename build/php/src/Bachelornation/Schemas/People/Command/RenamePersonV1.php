...
{
    const SCHEMA_ID = 'pbj:bachelornation:people:command:rename-person:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:people:command:rename-person';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:people:command:rename-person:v1';
    const MIXINS = [
