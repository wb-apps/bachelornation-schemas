...
namespace Bachelornation\Schemas\People\Command;
...
{
    const SCHEMA_ID = 'pbj:bachelornation:people:command:create-person:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:people:command:create-person';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:people:command:create-person:v1';
    const MIXINS = [
