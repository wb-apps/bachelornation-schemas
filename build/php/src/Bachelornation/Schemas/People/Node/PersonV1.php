...
{
    const SCHEMA_ID = 'pbj:bachelornation:people:node:person:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:people:node:person';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:people:node:person:v1';
    const MIXINS = [
