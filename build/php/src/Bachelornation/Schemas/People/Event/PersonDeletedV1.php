...
{
    const SCHEMA_ID = 'pbj:bachelornation:people:event:person-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:people:event:person-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:people:event:person-deleted:v1';
    const MIXINS = [
