...
{
    const SCHEMA_ID = 'pbj:bachelornation:people:event:person-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:people:event:person-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:people:event:person-created:v1';
    const MIXINS = [
