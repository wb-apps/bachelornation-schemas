...
{
    const SCHEMA_ID = 'pbj:bachelornation:people:event:person-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:people:event:person-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:people:event:person-updated:v1';
    const MIXINS = [
