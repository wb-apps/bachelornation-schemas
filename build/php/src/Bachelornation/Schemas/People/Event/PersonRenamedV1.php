...
{
    const SCHEMA_ID = 'pbj:bachelornation:people:event:person-renamed:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:people:event:person-renamed';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:people:event:person-renamed:v1';
    const MIXINS = [
