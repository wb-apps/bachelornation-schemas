...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:request:search-promotions-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:request:search-promotions-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:request:search-promotions-request:v1';
    const MIXINS = [
