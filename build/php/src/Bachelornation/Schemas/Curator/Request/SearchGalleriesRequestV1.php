...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:request:search-galleries-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:request:search-galleries-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:request:search-galleries-request:v1';
    const MIXINS = [
