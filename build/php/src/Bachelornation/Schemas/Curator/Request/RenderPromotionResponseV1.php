...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:request:render-promotion-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:request:render-promotion-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:request:render-promotion-response:v1';
    const MIXINS = [
