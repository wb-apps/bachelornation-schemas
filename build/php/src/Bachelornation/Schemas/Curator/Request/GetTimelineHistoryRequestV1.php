...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:request:get-timeline-history-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:request:get-timeline-history-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:request:get-timeline-history-request:v1';
    const MIXINS = [
