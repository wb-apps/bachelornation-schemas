...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:request:render-promotion-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:request:render-promotion-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:request:render-promotion-request:v1';
    const MIXINS = [
