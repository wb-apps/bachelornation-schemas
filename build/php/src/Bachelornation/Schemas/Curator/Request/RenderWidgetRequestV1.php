...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:request:render-widget-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:request:render-widget-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:request:render-widget-request:v1';
    const MIXINS = [
