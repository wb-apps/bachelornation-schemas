...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:request:search-widgets-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:request:search-widgets-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:request:search-widgets-request:v1';
    const MIXINS = [
