...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:request:get-timeline-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:request:get-timeline-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:request:get-timeline-response:v1';
    const MIXINS = [
