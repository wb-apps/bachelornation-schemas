...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:request:get-widget-history-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:request:get-widget-history-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:request:get-widget-history-request:v1';
    const MIXINS = [
