...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:request:search-widgets-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:request:search-widgets-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:request:search-widgets-response:v1';
    const MIXINS = [
