...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:request:search-timelines-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:request:search-timelines-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:request:search-timelines-response:v1';
    const MIXINS = [
