...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:request:render-widget-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:request:render-widget-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:request:render-widget-response:v1';
    const MIXINS = [
