...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:request:get-promotion-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:request:get-promotion-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:request:get-promotion-response:v1';
    const MIXINS = [
