...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:request:search-promotions-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:request:search-promotions-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:request:search-promotions-response:v1';
    const MIXINS = [
