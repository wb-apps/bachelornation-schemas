...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:request:get-teaser-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:request:get-teaser-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:request:get-teaser-response:v1';
    const MIXINS = [
