...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:promotion-unpublished:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:promotion-unpublished';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:promotion-unpublished:v1';
    const MIXINS = [
