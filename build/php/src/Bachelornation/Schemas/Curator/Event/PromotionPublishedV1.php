...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:promotion-published:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:promotion-published';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:promotion-published:v1';
    const MIXINS = [
