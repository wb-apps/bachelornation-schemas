...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:gallery-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:gallery-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:gallery-deleted:v1';
    const MIXINS = [
