...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:widget-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:widget-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:widget-created:v1';
    const MIXINS = [
