...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:gallery-renamed:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:gallery-renamed';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:gallery-renamed:v1';
    const MIXINS = [
