...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:timeline-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:timeline-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:timeline-updated:v1';
    const MIXINS = [
