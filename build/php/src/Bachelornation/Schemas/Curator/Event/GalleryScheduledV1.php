...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:gallery-scheduled:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:gallery-scheduled';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:gallery-scheduled:v1';
    const MIXINS = [
