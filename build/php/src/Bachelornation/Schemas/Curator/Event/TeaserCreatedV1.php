...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:teaser-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:teaser-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:teaser-created:v1';
    const MIXINS = [
