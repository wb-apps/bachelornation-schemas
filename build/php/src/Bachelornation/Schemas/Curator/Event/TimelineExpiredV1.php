...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:timeline-expired:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:timeline-expired';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:timeline-expired:v1';
    const MIXINS = [
