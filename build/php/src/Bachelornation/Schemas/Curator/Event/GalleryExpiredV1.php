...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:gallery-expired:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:gallery-expired';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:gallery-expired:v1';
    const MIXINS = [
