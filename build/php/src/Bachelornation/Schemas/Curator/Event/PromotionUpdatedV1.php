...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:promotion-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:promotion-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:promotion-updated:v1';
    const MIXINS = [
