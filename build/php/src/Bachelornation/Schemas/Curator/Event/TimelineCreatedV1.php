...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:timeline-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:timeline-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:timeline-created:v1';
    const MIXINS = [
