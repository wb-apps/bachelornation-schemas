...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:widget-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:widget-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:widget-deleted:v1';
    const MIXINS = [
