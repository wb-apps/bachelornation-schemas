...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:teaser-expired:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:teaser-expired';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:teaser-expired:v1';
    const MIXINS = [
