...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:gallery-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:gallery-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:gallery-updated:v1';
    const MIXINS = [
