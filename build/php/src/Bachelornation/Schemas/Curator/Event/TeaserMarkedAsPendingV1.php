...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:teaser-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:teaser-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:teaser-marked-as-pending:v1';
    const MIXINS = [
