...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:teaser-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:teaser-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:teaser-deleted:v1';
    const MIXINS = [
