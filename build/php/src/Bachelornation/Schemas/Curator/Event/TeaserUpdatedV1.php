...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:teaser-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:teaser-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:teaser-updated:v1';
    const MIXINS = [
