...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:widget-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:widget-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:widget-updated:v1';
    const MIXINS = [
