...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:promotion-scheduled:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:promotion-scheduled';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:promotion-scheduled:v1';
    const MIXINS = [
