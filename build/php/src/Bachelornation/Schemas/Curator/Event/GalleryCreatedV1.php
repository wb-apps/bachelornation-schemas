...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:gallery-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:gallery-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:gallery-created:v1';
    const MIXINS = [
