...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:timeline-renamed:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:timeline-renamed';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:timeline-renamed:v1';
    const MIXINS = [
