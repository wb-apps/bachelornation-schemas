...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:teaser-unpublished:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:teaser-unpublished';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:teaser-unpublished:v1';
    const MIXINS = [
