...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:promotion-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:promotion-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:promotion-created:v1';
    const MIXINS = [
