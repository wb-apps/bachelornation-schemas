...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:gallery-unpublished:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:gallery-unpublished';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:gallery-unpublished:v1';
    const MIXINS = [
