...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:teaser-published:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:teaser-published';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:teaser-published:v1';
    const MIXINS = [
