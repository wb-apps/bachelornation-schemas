...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:teaser-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:teaser-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:teaser-marked-as-draft:v1';
    const MIXINS = [
