...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:promotion-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:promotion-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:promotion-deleted:v1';
    const MIXINS = [
