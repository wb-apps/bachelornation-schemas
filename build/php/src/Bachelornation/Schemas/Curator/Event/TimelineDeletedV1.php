...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:timeline-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:timeline-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:timeline-deleted:v1';
    const MIXINS = [
