...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:gallery-published:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:gallery-published';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:gallery-published:v1';
    const MIXINS = [
