...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:timeline-published:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:timeline-published';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:timeline-published:v1';
    const MIXINS = [
