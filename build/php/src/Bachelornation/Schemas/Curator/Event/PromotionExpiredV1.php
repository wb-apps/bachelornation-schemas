...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:promotion-expired:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:promotion-expired';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:promotion-expired:v1';
    const MIXINS = [
