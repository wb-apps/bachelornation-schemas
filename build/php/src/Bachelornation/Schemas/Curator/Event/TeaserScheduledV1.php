...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:teaser-scheduled:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:teaser-scheduled';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:teaser-scheduled:v1';
    const MIXINS = [
