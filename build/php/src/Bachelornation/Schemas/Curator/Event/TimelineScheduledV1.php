...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:timeline-scheduled:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:timeline-scheduled';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:timeline-scheduled:v1';
    const MIXINS = [
