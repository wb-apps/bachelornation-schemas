...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:event:timeline-unpublished:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:event:timeline-unpublished';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:event:timeline-unpublished:v1';
    const MIXINS = [
