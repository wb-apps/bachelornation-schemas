...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:mark-teaser-as-pending:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:mark-teaser-as-pending';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:mark-teaser-as-pending:v1';
    const MIXINS = [
