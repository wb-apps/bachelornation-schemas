...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:delete-gallery:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:delete-gallery';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:delete-gallery:v1';
    const MIXINS = [
