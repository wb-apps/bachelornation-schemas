...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:publish-promotion:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:publish-promotion';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:publish-promotion:v1';
    const MIXINS = [
