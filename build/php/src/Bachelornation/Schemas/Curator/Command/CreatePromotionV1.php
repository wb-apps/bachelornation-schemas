...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:create-promotion:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:create-promotion';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:create-promotion:v1';
    const MIXINS = [
