...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:publish-timeline:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:publish-timeline';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:publish-timeline:v1';
    const MIXINS = [
