...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:create-teaser:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:create-teaser';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:create-teaser:v1';
    const MIXINS = [
