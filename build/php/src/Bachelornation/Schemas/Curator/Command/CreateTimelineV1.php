...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:create-timeline:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:create-timeline';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:create-timeline:v1';
    const MIXINS = [
