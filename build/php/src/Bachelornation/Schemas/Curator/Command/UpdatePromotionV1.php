...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:update-promotion:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:update-promotion';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:update-promotion:v1';
    const MIXINS = [
