...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:delete-promotion:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:delete-promotion';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:delete-promotion:v1';
    const MIXINS = [
