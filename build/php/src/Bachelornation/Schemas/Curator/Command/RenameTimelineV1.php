...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:rename-timeline:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:rename-timeline';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:rename-timeline:v1';
    const MIXINS = [
