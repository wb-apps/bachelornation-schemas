...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:expire-teaser:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:expire-teaser';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:expire-teaser:v1';
    const MIXINS = [
