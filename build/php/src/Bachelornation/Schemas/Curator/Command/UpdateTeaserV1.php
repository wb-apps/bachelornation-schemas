...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:update-teaser:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:update-teaser';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:update-teaser:v1';
    const MIXINS = [
