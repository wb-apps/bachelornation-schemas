...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:update-gallery:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:update-gallery';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:update-gallery:v1';
    const MIXINS = [
