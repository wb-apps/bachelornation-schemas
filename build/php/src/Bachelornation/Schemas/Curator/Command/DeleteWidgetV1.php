...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:delete-widget:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:delete-widget';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:delete-widget:v1';
    const MIXINS = [
