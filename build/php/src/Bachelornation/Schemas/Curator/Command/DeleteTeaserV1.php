...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:delete-teaser:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:delete-teaser';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:delete-teaser:v1';
    const MIXINS = [
