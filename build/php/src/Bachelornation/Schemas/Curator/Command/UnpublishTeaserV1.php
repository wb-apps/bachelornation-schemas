...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:unpublish-teaser:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:unpublish-teaser';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:unpublish-teaser:v1';
    const MIXINS = [
