...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:sync-teaser:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:sync-teaser';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:sync-teaser:v1';
    const MIXINS = [
