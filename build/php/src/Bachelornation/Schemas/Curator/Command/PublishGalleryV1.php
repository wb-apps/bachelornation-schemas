...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:publish-gallery:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:publish-gallery';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:publish-gallery:v1';
    const MIXINS = [
