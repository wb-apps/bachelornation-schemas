...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:publish-teaser:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:publish-teaser';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:publish-teaser:v1';
    const MIXINS = [
