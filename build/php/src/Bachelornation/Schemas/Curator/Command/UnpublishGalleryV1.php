...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:unpublish-gallery:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:unpublish-gallery';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:unpublish-gallery:v1';
    const MIXINS = [
