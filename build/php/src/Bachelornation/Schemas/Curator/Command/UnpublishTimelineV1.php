...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:unpublish-timeline:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:unpublish-timeline';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:unpublish-timeline:v1';
    const MIXINS = [
