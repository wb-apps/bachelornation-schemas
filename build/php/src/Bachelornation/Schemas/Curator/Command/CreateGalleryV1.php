...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:create-gallery:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:create-gallery';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:create-gallery:v1';
    const MIXINS = [
