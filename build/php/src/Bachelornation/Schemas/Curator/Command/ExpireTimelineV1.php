...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:expire-timeline:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:expire-timeline';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:expire-timeline:v1';
    const MIXINS = [
