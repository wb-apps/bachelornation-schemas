...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:unpublish-promotion:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:unpublish-promotion';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:unpublish-promotion:v1';
    const MIXINS = [
