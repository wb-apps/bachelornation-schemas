...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:update-timeline:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:update-timeline';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:update-timeline:v1';
    const MIXINS = [
