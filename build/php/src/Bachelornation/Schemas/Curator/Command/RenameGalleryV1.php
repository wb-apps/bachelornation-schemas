...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:rename-gallery:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:rename-gallery';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:rename-gallery:v1';
    const MIXINS = [
