...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:expire-gallery:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:expire-gallery';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:expire-gallery:v1';
    const MIXINS = [
