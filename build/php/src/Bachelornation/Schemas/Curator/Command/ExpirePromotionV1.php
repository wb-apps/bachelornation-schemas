...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:expire-promotion:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:expire-promotion';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:expire-promotion:v1';
    const MIXINS = [
