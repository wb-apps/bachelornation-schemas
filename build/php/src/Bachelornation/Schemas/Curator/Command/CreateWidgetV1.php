...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:create-widget:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:create-widget';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:create-widget:v1';
    const MIXINS = [
