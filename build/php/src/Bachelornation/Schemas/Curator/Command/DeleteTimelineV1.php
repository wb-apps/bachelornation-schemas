...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:delete-timeline:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:delete-timeline';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:delete-timeline:v1';
    const MIXINS = [
