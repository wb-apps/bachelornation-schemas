...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:mark-teaser-as-draft:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:mark-teaser-as-draft';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:mark-teaser-as-draft:v1';
    const MIXINS = [
