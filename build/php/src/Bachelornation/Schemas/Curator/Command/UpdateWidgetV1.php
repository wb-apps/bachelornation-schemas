...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:command:update-widget:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:command:update-widget';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:command:update-widget:v1';
    const MIXINS = [
