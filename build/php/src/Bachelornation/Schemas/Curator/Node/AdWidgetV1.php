...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:ad-widget:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:ad-widget';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:ad-widget:v1';
    const MIXINS = [
