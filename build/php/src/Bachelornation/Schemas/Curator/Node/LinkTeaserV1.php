...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:link-teaser:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:link-teaser';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:link-teaser:v1';
    const MIXINS = [
