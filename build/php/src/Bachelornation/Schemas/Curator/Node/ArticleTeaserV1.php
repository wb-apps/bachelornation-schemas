...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:article-teaser:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:article-teaser';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:article-teaser:v1';
    const MIXINS = [
