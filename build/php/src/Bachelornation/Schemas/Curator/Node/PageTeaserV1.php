...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:page-teaser:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:page-teaser';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:page-teaser:v1';
    const MIXINS = [
