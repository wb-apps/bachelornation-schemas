...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:category-teaser:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:category-teaser';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:category-teaser:v1';
    const MIXINS = [
