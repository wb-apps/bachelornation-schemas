...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:spotlight-widget:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:spotlight-widget';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:spotlight-widget:v1';
    const MIXINS = [
