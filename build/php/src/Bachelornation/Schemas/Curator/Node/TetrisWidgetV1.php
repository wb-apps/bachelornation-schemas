...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:tetris-widget:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:tetris-widget';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:tetris-widget:v1';
    const MIXINS = [
