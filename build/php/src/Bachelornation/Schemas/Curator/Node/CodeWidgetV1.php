...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:code-widget:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:code-widget';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:code-widget:v1';
    const MIXINS = [
