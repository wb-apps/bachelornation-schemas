...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:gridler-widget:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:gridler-widget';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:gridler-widget:v1';
    const MIXINS = [
