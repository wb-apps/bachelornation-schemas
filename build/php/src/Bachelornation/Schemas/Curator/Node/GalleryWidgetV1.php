...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:gallery-widget:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:gallery-widget';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:gallery-widget:v1';
    const MIXINS = [
