...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:timeline-teaser:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:timeline-teaser';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:timeline-teaser:v1';
    const MIXINS = [
