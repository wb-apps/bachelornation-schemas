...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:video-teaser:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:video-teaser';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:video-teaser:v1';
    const MIXINS = [
