...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:gallery:1-0-1';
    const SCHEMA_CURIE = 'bachelornation:curator:node:gallery';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:gallery:v1';
    const MIXINS = [
