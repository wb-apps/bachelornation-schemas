...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:hero-bar-widget:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:hero-bar-widget';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:hero-bar-widget:v1';
    const MIXINS = [
