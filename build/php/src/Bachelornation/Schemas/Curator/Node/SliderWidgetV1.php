...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:slider-widget:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:slider-widget';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:slider-widget:v1';
    const MIXINS = [
