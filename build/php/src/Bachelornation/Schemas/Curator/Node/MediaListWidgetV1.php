...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:media-list-widget:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:media-list-widget';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:media-list-widget:v1';
    const MIXINS = [
