...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:person-teaser:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:person-teaser';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:person-teaser:v1';
    const MIXINS = [
