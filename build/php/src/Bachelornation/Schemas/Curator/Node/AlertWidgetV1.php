...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:alert-widget:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:alert-widget';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:alert-widget:v1';
    const MIXINS = [
