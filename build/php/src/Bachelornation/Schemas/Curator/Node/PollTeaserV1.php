...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:poll-teaser:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:poll-teaser';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:poll-teaser:v1';
    const MIXINS = [
