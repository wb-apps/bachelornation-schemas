...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:asset-teaser:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:asset-teaser';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:asset-teaser:v1';
    const MIXINS = [
