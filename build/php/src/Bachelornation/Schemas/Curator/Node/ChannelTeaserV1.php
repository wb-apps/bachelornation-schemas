...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:channel-teaser:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:channel-teaser';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:channel-teaser:v1';
    const MIXINS = [
