...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:carousel-widget:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:carousel-widget';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:carousel-widget:v1';
    const MIXINS = [
