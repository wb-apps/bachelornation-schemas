...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:timeline:1-0-1';
    const SCHEMA_CURIE = 'bachelornation:curator:node:timeline';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:timeline:v1';
    const MIXINS = [
