...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:showtimes-widget:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:showtimes-widget';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:showtimes-widget:v1';
    const MIXINS = [
