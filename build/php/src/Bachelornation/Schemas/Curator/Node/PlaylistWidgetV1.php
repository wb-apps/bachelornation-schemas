...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:playlist-widget:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:playlist-widget';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:playlist-widget:v1';
    const MIXINS = [
