...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:promotion:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:promotion';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:promotion:v1';
    const MIXINS = [
