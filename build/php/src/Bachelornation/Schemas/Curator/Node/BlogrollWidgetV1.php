...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:blogroll-widget:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:blogroll-widget';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:blogroll-widget:v1';
    const MIXINS = [
