...
{
    const SCHEMA_ID = 'pbj:bachelornation:curator:node:gallery-teaser:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:curator:node:gallery-teaser';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:curator:node:gallery-teaser:v1';
    const MIXINS = [
