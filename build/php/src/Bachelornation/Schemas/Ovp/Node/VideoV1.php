...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:node:video:1-0-1';
    const SCHEMA_CURIE = 'bachelornation:ovp:node:video';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:node:video:v1';
    const MIXINS = [
