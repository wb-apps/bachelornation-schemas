...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:command:publish-video:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:command:publish-video';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:command:publish-video:v1';
    const MIXINS = [
