...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:command:unpublish-video:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:command:unpublish-video';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:command:unpublish-video:v1';
    const MIXINS = [
