...
namespace Bachelornation\Schemas\Ovp\Command;
...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:command:mark-video-as-pending:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:command:mark-video-as-pending';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:command:mark-video-as-pending:v1';
    const MIXINS = [
