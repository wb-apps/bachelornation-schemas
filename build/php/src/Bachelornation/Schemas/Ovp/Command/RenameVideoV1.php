...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:command:rename-video:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:command:rename-video';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:command:rename-video:v1';
    const MIXINS = [
