...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:command:expire-video:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:command:expire-video';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:command:expire-video:v1';
    const MIXINS = [
