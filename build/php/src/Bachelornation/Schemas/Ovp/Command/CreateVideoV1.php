...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:command:create-video:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:command:create-video';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:command:create-video:v1';
    const MIXINS = [
