...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:command:delete-video:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:command:delete-video';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:command:delete-video:v1';
    const MIXINS = [
