...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:command:update-video:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:command:update-video';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:command:update-video:v1';
    const MIXINS = [
