...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:request:get-video-history-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:request:get-video-history-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:request:get-video-history-request:v1';
    const MIXINS = [
