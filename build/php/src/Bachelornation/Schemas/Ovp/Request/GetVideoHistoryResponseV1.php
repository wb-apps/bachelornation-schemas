...
namespace Bachelornation\Schemas\Ovp\Request;
...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:request:get-video-history-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:request:get-video-history-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:request:get-video-history-response:v1';
    const MIXINS = [
