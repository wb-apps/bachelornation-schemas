...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:request:search-videos-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:request:search-videos-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:request:search-videos-request:v1';
    const MIXINS = [
