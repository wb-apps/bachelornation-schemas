...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:request:get-video-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:request:get-video-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:request:get-video-response:v1';
    const MIXINS = [
