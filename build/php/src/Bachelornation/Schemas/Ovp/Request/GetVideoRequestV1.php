...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:request:get-video-request:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:request:get-video-request';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:request:get-video-request:v1';
    const MIXINS = [
