...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:request:search-videos-response:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:request:search-videos-response';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:request:search-videos-response:v1';
    const MIXINS = [
