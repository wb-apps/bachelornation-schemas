...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:event:video-renamed:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:event:video-renamed';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:event:video-renamed:v1';
    const MIXINS = [
