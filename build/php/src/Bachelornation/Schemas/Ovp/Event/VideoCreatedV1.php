...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:event:video-created:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:event:video-created';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:event:video-created:v1';
    const MIXINS = [
