...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:event:video-scheduled:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:event:video-scheduled';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:event:video-scheduled:v1';
    const MIXINS = [
