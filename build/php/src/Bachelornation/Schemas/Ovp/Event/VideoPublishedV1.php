...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:event:video-published:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:event:video-published';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:event:video-published:v1';
    const MIXINS = [
