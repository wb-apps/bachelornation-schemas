...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:event:video-unpublished:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:event:video-unpublished';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:event:video-unpublished:v1';
    const MIXINS = [
