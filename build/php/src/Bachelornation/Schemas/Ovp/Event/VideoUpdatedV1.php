...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:event:video-updated:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:event:video-updated';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:event:video-updated:v1';
    const MIXINS = [
