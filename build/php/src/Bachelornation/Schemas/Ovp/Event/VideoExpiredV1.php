...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:event:video-expired:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:event:video-expired';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:event:video-expired:v1';
    const MIXINS = [
