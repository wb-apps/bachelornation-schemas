...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:event:video-deleted:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:event:video-deleted';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:event:video-deleted:v1';
    const MIXINS = [
