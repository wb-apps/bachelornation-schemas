...
namespace Bachelornation\Schemas\Ovp\Event;
...
{
    const SCHEMA_ID = 'pbj:bachelornation:ovp:event:video-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'bachelornation:ovp:event:video-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'bachelornation:ovp:event:video-marked-as-pending:v1';
    const MIXINS = [
